...
* independently revalidates the active-v4 frozen-T2V scalar calibration graph
  and all forty canonical score receipts;
...
import validate_pair_v5_t2v_calibration_mainline_v3 as mainline_calibration  # noqa: E402


SCORE_SCHEMA = "bernini-pair-v5-native-rv2v-global-action-score-v4"
GROUP_SCHEMA = "bernini-pair-v5-native-rv2v-global-action-score-group-v4"
SAFE_PARETO_ACTION_SCHEMA = "bernini-pair-v5-safe-pareto-action-input-v4"
SCORE_FILENAME = "pair-v5-native-rv2v-action-score-v4.json"
GROUP_FILENAME = "pair-v5-native-rv2v-action-score-{group_id}-v4.json"
SAFE_PARETO_ACTION_FILENAME = "pair-v5-safe-pareto-action-input-v4.json"
...
NATIVE_SCORE_INPUT_CLOSURE = {
    ...
    "formal_action_scalar_definition": (
        frozen_mace_runtime.CANONICAL_ACTION_ENERGY_ARITHMETIC_SCHEMA
    ),
    "canonical_v4_scalar_recomputed_from_exact_fp32_branch_energies": True,
    "active_repository_action_scalar_consumed": True,
    "origin_device_log1p_used_for_calibration": False,
    "legacy_v3_compatibility_scalar_consumed": False,
...
_MACE_FIELDS = frozenset(
    {
        ...
        "canonical_action_energy_packet",
        "canonical_action_energy_packet_digest",
...
def load_mainline_calibration_bundle(
    *,
    ...
    """Recompute the active-v4 scalar graph and expose only its maps."""
    ...
    try:
        ...
        raise PairV5NativeRV2VActionScoreError(
            f"active-v4 T2V scalar calibration failed revalidation: {error}"
        ) from error
    ...
    if (
        ...
        != frozen_mace_runtime.SCORE_RECEIPT_SCHEMA
        or authorization.get("formal_score_filename")
        != frozen_mace_runtime.SCORE_RECEIPT_FILENAME
        or authorization.get("formal_score_scalar_definition")
        != frozen_mace_runtime.CANONICAL_ACTION_ENERGY_ARITHMETIC_SCHEMA
        or authorization.get("formal_score_arithmetic_contract_digest")
        != frozen_mace_runtime.canonical_action_energy_arithmetic_contract()[
            "contract_digest"
        ]
        or authorization.get(
            "formal_receipts_validated_by_active_v4_canonical_code"
        ) is not True
        or authorization.get("active_repository_score_schema_consumed") is not True
        or authorization.get("legacy_v3_compatibility_score_consumed") is not False
    ):
        raise PairV5NativeRV2VActionScoreError(
            "active-v4 T2V calibration exceeded map-only authority"
        )
    ...
    if (
        ...
        raise PairV5NativeRV2VActionScoreError(
            "active-v4 T2V calibration binding differs"
        )
    return bundle
...
def _calibration_binding(
    ...
    return {
        ...
        "formal_score_filename": authorization["formal_score_filename"],
        "formal_score_scalar_definition": authorization[
            "formal_score_scalar_definition"
        ],
        "formal_score_arithmetic_contract_digest": authorization[
            "formal_score_arithmetic_contract_digest"
        ],
        "formal_receipts_validated_by_active_v4_canonical_code": authorization[
            "formal_receipts_validated_by_active_v4_canonical_code"
        ],
        "active_repository_score_schema_consumed": authorization[
            "active_repository_score_schema_consumed"
        ],
        "legacy_v3_compatibility_score_consumed": authorization[
            "legacy_v3_compatibility_score_consumed"
        ],
...
def make_score_receipt(
    *,
    ...
    try:
        canonical_energy = frozen_mace_runtime.make_canonical_action_energy_packet(
            score.energy
        )
    except frozen_mace_runtime.PairV5T2VEnergyScoringError as error:
        raise PairV5NativeRV2VActionScoreError(str(error)) from error
    action_energy = canonical_energy["global_action_energy"]
    negative_energies = canonical_energy[
        "global_hard_negative_energy_by_branch"
    ]
    hardest_branch = canonical_energy["global_hardest_negative_branch"]
    raw = canonical_energy["raw_global_action_energy_score"]
    ...
    unsigned = {
        ...
        "mace": {
            "definition": frozen_mace_runtime.CANONICAL_ACTION_ENERGY_ARITHMETIC_SCHEMA,
            "energy_epsilon": canonical_energy["energy_epsilon"],
            "global_action_energy": action_energy,
            "global_hard_negative_energy_by_branch": negative_energies,
            "global_negative_log_energy_ratio_by_branch": canonical_energy[
                "global_negative_log_energy_ratio_by_branch"
            ],
            "canonical_negative_log_energy_ratio_decimal_by_branch": canonical_energy[
                "canonical_negative_log_energy_ratio_decimal_by_branch"
            ],
            "canonical_global_action_energy_score_decimal": canonical_energy[
                "canonical_global_action_energy_score_decimal"
            ],
            "canonical_action_energy_arithmetic_contract": canonical_energy[
                "canonical_action_energy_arithmetic_contract"
            ],
            "global_hardest_negative_branch": hardest_branch,
            "live_origin_global_action_energy_score_diagnostic": canonical_energy[
                "live_origin_global_action_energy_score_diagnostic"
            ],
            "live_origin_global_hardest_negative_branch_diagnostic": canonical_energy[
                "live_origin_global_hardest_negative_branch_diagnostic"
            ],
            "live_origin_negative_log_energy_ratio_by_branch_diagnostic": canonical_energy[
                "live_origin_negative_log_energy_ratio_by_branch_diagnostic"
            ],
            "mace_live_tensor_formula_proof_diagnostic": canonical_energy[
                "mace_live_tensor_formula_proof_diagnostic"
            ],
            "canonical_action_energy_packet": canonical_energy,
            "canonical_action_energy_packet_digest": canonical_energy["packet_digest"],
...
def validate_score_receipt(value: Any) -> dict[str, Any]:
    ...
    if (
        ...
        != frozen_mace_runtime.SCORE_RECEIPT_SCHEMA
        or calibration["formal_score_filename"]
        != frozen_mace_runtime.SCORE_RECEIPT_FILENAME
        or calibration["formal_score_scalar_definition"]
        != frozen_mace_runtime.CANONICAL_ACTION_ENERGY_ARITHMETIC_SCHEMA
        or calibration["formal_score_arithmetic_contract_digest"]
        != frozen_mace_runtime.canonical_action_energy_arithmetic_contract()[
            "contract_digest"
        ]
        or calibration["formal_receipts_validated_by_active_v4_canonical_code"] is not True
        or calibration["active_repository_score_schema_consumed"] is not True
        or calibration["legacy_v3_compatibility_score_consumed"] is not False
    ...
    del phase
    try:
        canonical_energy = frozen_mace_runtime.validate_canonical_action_energy_packet(
            score["canonical_action_energy_packet"]
        )
    except frozen_mace_runtime.PairV5T2VEnergyScoringError as error:
        raise PairV5NativeRV2VActionScoreError(str(error)) from error
    ...
    if (
        score["definition"]
        != frozen_mace_runtime.CANONICAL_ACTION_ENERGY_ARITHMETIC_SCHEMA
        or score["canonical_action_energy_packet_digest"] != canonical_energy["packet_digest"]
        or score["energy_epsilon"] != canonical_energy["energy_epsilon"]
        or score["global_action_energy"]
        != canonical_energy["global_action_energy"]
        or score["global_hard_negative_energy_by_branch"]
        != canonical_energy["global_hard_negative_energy_by_branch"]
        or score["global_negative_log_energy_ratio_by_branch"]
        != canonical_energy["global_negative_log_energy_ratio_by_branch"]
        or score["canonical_negative_log_energy_ratio_decimal_by_branch"]
        != canonical_energy["canonical_negative_log_energy_ratio_decimal_by_branch"]
        or score["canonical_global_action_energy_score_decimal"]
        != canonical_energy["canonical_global_action_energy_score_decimal"]
        or score["canonical_action_energy_arithmetic_contract"]
        != canonical_energy["canonical_action_energy_arithmetic_contract"]
        or score["global_hardest_negative_branch"]
        != canonical_energy["global_hardest_negative_branch"]
        or score["live_origin_global_action_energy_score_diagnostic"]
        != canonical_energy["live_origin_global_action_energy_score_diagnostic"]
        or score["live_origin_global_hardest_negative_branch_diagnostic"]
        != canonical_energy["live_origin_global_hardest_negative_branch_diagnostic"]
        or score["live_origin_negative_log_energy_ratio_by_branch_diagnostic"]
        != canonical_energy["live_origin_negative_log_energy_ratio_by_branch_diagnostic"]
        or score["mace_live_tensor_formula_proof_diagnostic"]
        != canonical_energy["mace_live_tensor_formula_proof_diagnostic"]
        or raw != canonical_energy["raw_global_action_energy_score"]
    ...
    try:
        ...
        if distributed.rank == 0:
            ...
            group_unsigned = {
                ...
                "formal_t2v_score_filename": bundle["authorization"][
                    "formal_score_filename"
                ],
                "formal_t2v_score_scalar_definition": bundle["authorization"][
                    "formal_score_scalar_definition"
                ],
                "formal_t2v_score_arithmetic_contract_digest": bundle[
                    "authorization"
                ]["formal_score_arithmetic_contract_digest"],
                "active_v4_canonical_score_consumed": True,
