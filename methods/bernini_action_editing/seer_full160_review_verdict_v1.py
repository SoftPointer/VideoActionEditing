...
BLANK_SCHEMA_VERSION = "bernini-seer-full160-strict-paired-full-video-review-v1"
VERDICT_SCHEMA_VERSION = "bernini-seer-full160-strict-verdict-v1"
CORE4_IIDS = (
    "99cde432839f4240",
    "6ea45d35943742bb",
    "311c82f83eca4a7f",
...
def _validate_master_binding(master: Mapping[str, Any]) -> None:
    ...
    if (
        ...
        != "bernini-seer-full160-core4-eval-master-binding-v1"
