#!/usr/bin/env python3
"""Materialize the fresh r13 in-allocation WORLD8 release on AUH.
...
EXPECTED = {
    "launcher": (
        "launch_saic_formal_v2_retained_fd_world8_canary_inallocation_r13.py",
        "9dac3f1701332cdcf0db3a11f3d67e6167680428bfe09000214ba85ebfe018ca",
    ),
    "wrapper": (
        "auh_canary_saic_formal_v2_retained_fd_world8_inallocation_r13.sh",
        "a5c191379128830bb877536a42e7271a2ade2a1c82b344846d4b5dc33da2ec79",
    ),
    "payload": (
        "auh_canary_saic_formal_v2_retained_fd_world8_payload_inallocation_r13.sh",
        "36438ff41f3f56786cbcaad992759aa05d2a1db338a6cfc83e2d2b5c9c580951",
    ),
    "postflight": (
        "postflight_saic_formal_v2_retained_fd_world8_canary_inallocation_r13.py",
        "391dddb246474b3b260a1a0010e570244c46a40c17361d802ed4a2c1f5c2109b",
    ),
}
R10_INPUTS = {
    "runtime": (
...
def die(message: str) -> None:
    raise SystemExit(f"materialize-saic-fv2-fd-world8-inallocation-r13: {message}")
