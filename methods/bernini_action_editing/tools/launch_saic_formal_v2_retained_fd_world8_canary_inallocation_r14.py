...
RECEIPT = OUTPUT_PARENT / "inallocation-r14-step-launch-receipt.json"
CLIENT_RECEIPT = OUTPUT_PARENT / "inallocation-r14-srun-client-receipt.json"
LAUNCHER = INPUTS / "launch_saic_formal_v2_retained_fd_world8_canary_inallocation_r14.py"
WRAPPER = INPUTS / "auh_canary_saic_formal_v2_retained_fd_world8_inallocation_r14.sh"
PAYLOAD = INPUTS / "auh_canary_saic_formal_v2_retained_fd_world8_payload_inallocation_r14.sh"
...
POSTFLIGHT = POSTFLIGHT_ROOT / "postflight_saic_formal_v2_retained_fd_world8_canary_inallocation_r14.py"
...
EXPECTED_POSTFLIGHT_SHA256 = "3a80813f4ae23fca457f48920d2dc7de3197b8ba5415bc1fdddb7c20c0366b96"
...
def die(message: str) -> None:
    raise SystemExit(f"launch-saic-fv2-fd-world8-inallocation-r14: {message}")
...
STDIN_LOADER = (
    ...
    "exec(compile(raw,'inallocation-r14-step-bootstrap','exec'),{'__name__':'__main__'})"
)
