#!/usr/bin/env python3
"""Materialize the fresh r2 job143812/node293 r5d case00 package without Slurm.
...
TARGETS = {
    ...
    / "bernini_full644_exploratory_matched_eval_auh_r5d_job143812_node293_"
      "case00_847b91a2_c91de7eb_85ccc17b_r2",
}
VACE_PYTHON = Path(
...
def _materialize(args: argparse.Namespace) -> dict[str, Any]:
    ...
    report: dict[str, Any] = {
        "schema_version": "full644-exploratory-matched-r5d-case00-materialization-v2",
