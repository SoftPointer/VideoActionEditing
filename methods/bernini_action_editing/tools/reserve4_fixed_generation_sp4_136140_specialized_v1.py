...
def _discover_live_cgroup_v2(
    *,
    ...
    _require(
        slurm_job_id == "136140" and slurm_step_id.isdecimal(),
...
def validate_host_cgroup_memory_monitor_start(
    ...
    _require(
        ...
        and value.get("slurm_job_id") == "136140"
...
def run_host_cgroup_memory_monitor(
    *,
    ...
    _require(
        slurm_job_id == "136140" and slurm_step_id.isdecimal(),
        "host memory monitor is not bound to the retained 136140 Slurm child",
    )
    _require(
...
def load_compile_smoke_receipt(
    ...
    _require(
        ...
        and monitor.get("slurm_job_id") == "136140"
