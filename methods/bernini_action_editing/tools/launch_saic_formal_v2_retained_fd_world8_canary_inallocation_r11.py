...
STEP_RECEIPT_SCHEMA = "saic-formal-v2-retained-fd-world8-inallocation-step-launch-v1"
...
RECEIPT = OUTPUT_PARENT / "inallocation-step-launch-receipt.json"
CLIENT_RECEIPT = OUTPUT_PARENT / "inallocation-srun-client-receipt.json"
LAUNCHER = INPUTS / "launch_saic_formal_v2_retained_fd_world8_canary_inallocation_r11.py"
WRAPPER = INPUTS / "auh_canary_saic_formal_v2_retained_fd_world8_inallocation_r11.sh"
PAYLOAD = INPUTS / "auh_canary_saic_formal_v2_retained_fd_world8_payload_inallocation_r11.sh"
...
POSTFLIGHT = POSTFLIGHT_ROOT / "postflight_saic_formal_v2_retained_fd_world8_canary_inallocation_r11.py"
...
EXPECTED_WRAPPER_SHA256 = "d53bc14fc89f34a5062132e381fe0c19d120d890d623e27b193e0d55838e2825"
EXPECTED_PAYLOAD_SHA256 = "8d7e4fc18f2e6ee7eb977972267dc03156c8ba8c35f5e14d1509c95bdb04a5fa"
EXPECTED_POSTFLIGHT_SHA256 = "0e60c2724743759fd439dd44ba79ae9518d13331bd9e762e7353716e824f842b"
...
def die(message: str) -> None:
    raise SystemExit(f"launch-saic-fv2-fd-world8-inallocation-r11: {message}")
...
STDIN_LOADER = (
    ...
    "exec(compile(raw,'inallocation-step-bootstrap','exec'),{'__name__':'__main__'})"
)
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    command = [
        ...
        "--open-mode=truncate",
        f"--output={LOG_DIR}/saic-fv2-fd-w8-inalloc-%J.out",
        f"--error={LOG_DIR}/saic-fv2-fd-w8-inalloc-%J.err",
    ...
    try:
        ...
        client_core = {
            "schema_version": (
                "saic-formal-v2-retained-fd-world8-inallocation-srun-client-v1"
            ),
