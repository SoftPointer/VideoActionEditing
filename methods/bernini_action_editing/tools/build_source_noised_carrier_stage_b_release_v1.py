#!/usr/bin/env python3
"""Build the deterministic exact-closure Stage-B source-carrier release.
...
SCHEMA_VERSION = "bernini-source-noised-carrier-stage-b-release-v1"
...
RELEASE_FILES = BASE_RELEASE_FILES + STAGE_B_RELEASE_FILES
