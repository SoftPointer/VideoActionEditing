#!/usr/bin/env python3
"""Materialize the fresh r3 job143812/node293 r5d case00 package without Slurm.
...
TARGETS = {
    ...
    / "bernini_full644_exploratory_matched_eval_auh_r5d_job143812_node293_"
      "case00_847b91a2_c91de7eb_85ccc17b_r3",
}
VACE_PYTHON = Path(
...
STATIC_NOMODEL_PROBE = (
    "methods/bernini_action_editing/"
    "full644_exploratory_matched_r5d_static_nomodel_probe_v2.py"
)
...
DIAGNOSTIC_SOURCE_PINS = {
    ...
    STATIC_NOMODEL_PROBE:
        "fd6829d3b1f4b0e3bcbed91889b4f6f76eaf45a5884d44a9b9110ac87eb6cb4f",
    CPU_CONSUMPTION_PROBE:
...
def _materialize(args: argparse.Namespace) -> dict[str, Any]:
    ...
    report: dict[str, Any] = {
        "schema_version": "full644-exploratory-matched-r5d-case00-materialization-v3",
