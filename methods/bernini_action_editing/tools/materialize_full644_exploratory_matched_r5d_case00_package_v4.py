#!/usr/bin/env python3
"""Materialize the fresh r4 job143812/node293 r5d case00 package without Slurm.
...
TARGETS = {
    ...
    / "bernini_full644_exploratory_matched_eval_auh_r5d_job143812_node293_"
      "case00_847b91a2_c91de7eb_85ccc17b_r4",
}
VACE_PYTHON = Path(
...
STATIC_NOMODEL_PROBE = (
    "methods/bernini_action_editing/"
    "full644_exploratory_matched_r5d_static_nomodel_probe_v3.py"
)
...
DIAGNOSTIC_SOURCE_PINS = {
    ...
    STATIC_NOMODEL_PROBE:
        "c03a40b1e1853a76f33bd98ea2c96108a5c94cf02d6970e60d1dfcc22f2cd7b0",
    CPU_CONSUMPTION_PROBE:
...
def _materialize(args: argparse.Namespace) -> dict[str, Any]:
    ...
    report: dict[str, Any] = {
        "schema_version": "full644-exploratory-matched-r5d-case00-materialization-v4",
