#!/usr/bin/env python3
"""Exactly-once submit the guard-v2 SAIC pure-T2V r6 full60 job."""
...
EXPECTED_WRAPPER_SHA256 = (
    "faa582b2efe6431562f8d766eadb0c1b8784185b07c416ed177e0175d2a6b37f"
)
EXPECTED_GATE_SHA256 = (
    "99631ff6537e60d465a571b653fa44b91bfad94d0f3df9454e65c10905358296"
)
...
EXPECTED_GATE = FORMAL_RELEASE_ROOT / "inputs/saic_t2v_formal_v2_gate.py"
...
EXPECTED_OUTPUT_ROOT = (
    FORMAL_ROOT / "runs/t2v-events-topup-r6-formal-v2-guard1a38-20260812-r1"
)
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    canary_admission = {**canary, "sacct_observation": sacct_observation}
    ...
    command = [
        "/usr/bin/sbatch",
        "--parsable",
        f"--output={slurm_log_dir}/saic-t2v-topup-r6-v2-%j.out",
        f"--error={slurm_log_dir}/saic-t2v-topup-r6-v2-%j.err",
        "--export=NONE," + ",".join(
