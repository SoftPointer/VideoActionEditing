...
try:
    from methods.bernini_action_editing import (
        case01_object_trajectory_exact5_eval_v4 as trajectory_eval,
    )
    from methods.bernini_action_editing import (
...
PINNED_PHYSICAL_SHA256 = {
    "runner": "326ccfff1a09d6db8c93d02cfe6018e465e127263547f325cc7f18e7d16a7148",
    "frozen_runner": "847b91a267fe55cfbfa793027548f82beb5ec9630efab329878576ae6c5a9223",
    "exact5_eval": "381ba375147bec7580b451226b07b3d1cab9125866978602de05fbba4f16aaa3",
...
def _evaluation_authority() -> dict[str, dict[str, Any]]:
    """Bind the semantic evaluators and the complete fresh core4 source chain."""
    ...
    declarations = (
        ...
        (
            "runner",
            "exact5-fresh-core4-runner",
            method_root / "case01_object_trajectory_exact5_runner_v4.py",
            EXPECTED_RUNNER_SHA256,
            EXPECTED_RUNNER_SIZE,
        ),
        (
            "composite",
            "exact5-fresh-core4-composite",
            method_root / "infer_case01_object_trajectory_oracle_auh_r5f_v4.py",
            EXPECTED_COMPOSITE_SHA256,
            EXPECTED_COMPOSITE_SIZE,
        ),
        (
            "base_adapter",
            "exact5-fresh-core4-base-adapter",
            method_root / "full644_exploratory_matched_infer_adapter_v3.py",
            EXPECTED_BASE_ADAPTER_SHA256,
            EXPECTED_BASE_ADAPTER_SIZE,
        ),
        (
            "object_wrapper_inner",
            "exact5-source-loaded-object-wrapper-inner",
            method_root / "infer_case01_object_trajectory_oracle_v1.py",
            EXPECTED_OBJECT_WRAPPER_INNER_SHA256,
            EXPECTED_OBJECT_WRAPPER_INNER_SIZE,
        ),
        (
            "strict_eval",
...
def _validate_physical_bindings(
    ...
    *,
    ...
    _require(
        producer.get("inference_wrapper_sha256") == EXPECTED_COMPOSITE_SHA256
        and producer.get("inference_wrapper_size") == EXPECTED_COMPOSITE_SIZE
        and producer.get("object_wrapper_inner_sha256")
        == EXPECTED_OBJECT_WRAPPER_INNER_SHA256
        and producer.get("object_wrapper_inner_size")
        == EXPECTED_OBJECT_WRAPPER_INNER_SIZE
