#!/usr/bin/env python3
"""Materialize the fresh r12 in-allocation WORLD8 release on AUH.
...
EXPECTED = {
    "launcher": (
        "launch_saic_formal_v2_retained_fd_world8_canary_inallocation_r12.py",
        "45734d4cf3fb3442c5298f2cf72eb2c132dddaa50d969d27b82968dc75cf64ad",
    ),
    "wrapper": (
        "auh_canary_saic_formal_v2_retained_fd_world8_inallocation_r12.sh",
        "cd179e3e1a141c971765e9cdfb5f25ffbc22f784bde0c2fc23ccfb617a44771d",
    ),
    "payload": (
        "auh_canary_saic_formal_v2_retained_fd_world8_payload_inallocation_r12.sh",
        "4b30a3fd8cdce12f24b86e499274c64734c969d0c425e2232859449b5800d3df",
    ),
    "postflight": (
        "postflight_saic_formal_v2_retained_fd_world8_canary_inallocation_r12.py",
        "ac462c800d2954bf4ba841b7b90a530c1d9dd0c93ef7f85bb01c38d3246c0cb8",
    ),
}
R10_INPUTS = {
    "runtime": (
...
def die(message: str) -> None:
    raise SystemExit(f"materialize-saic-fv2-fd-world8-inallocation-r12: {message}")
