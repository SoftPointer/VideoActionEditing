#!/usr/bin/env python3
"""Build/audit the exact-member 136141 reserve4 fit-media release.

This release can only render the sealed fit split: four seed cells and ten
...
the native receipt and mandatory compile-smoke replay.  Confirmation,
review certification, Phi extraction, manifest
...
SCHEMA_VERSION = "bernini-generic-action-data-prep-release-v1"
RELEASE_GENERATION = "r13"
...
FILES_AND_MODES: Mapping[str, int] = {
    **{path: 0o444 for path in _RUNTIME_FILES + _TOOLS},
    "generic_action_data_prep_controller_v1.py": 0o444,
    "scripts/auh_generic_action_data_prep_136141_world4_v1.sh": 0o555,
...
COMPONENT_FILES: Mapping[str, str] = {
    ...
    "launcher_sha256": "scripts/auh_generic_action_data_prep_136141_world4_v1.sh",
...
def build_manifest(
    ...
    unsigned = {
        ...
        "release_scope": "reserve4-fit40-media-only-pending-external-blind-review",
