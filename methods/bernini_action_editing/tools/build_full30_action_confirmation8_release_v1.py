#!/usr/bin/env python3
"""Build/audit the deterministic BOX-EXP-009 confirmation exact8 release."""
...
SCHEMA_VERSION = "bernini-full30-action-confirmation8-release-v1"
...
RESOURCE_SPECIALIZED = (
    "tools/reserve4_fixed_generation_sp4_136309_specialized_v1.py"
)
...
_NEW_FILES = (
    "full30_action_confirmation8_plan_v1.py",
    "full30_action_confirmation8_generator_v1.py",
    "full30_action_confirmation8_controller_v1.py",
)
_TOOLS = (
    "tools/build_full30_action_confirmation8_release_v1.py",
...
FILES_AND_MODES: Mapping[str, int] = {
    **{path: 0o444 for path in _RUNTIME_FILES + _NEW_FILES + _TOOLS},
    "scripts/auh_full30_action_confirmation8_136309_world4_v1.sh": 0o555,
    "scripts/auh_generic_action_data_prep_rank_exec_v1.sh": 0o555,
}
COMPONENT_FILES: Mapping[str, str] = {
    "plan_sha256": "full30_action_confirmation8_plan_v1.py",
    "generator_sha256": "full30_action_confirmation8_generator_v1.py",
    "controller_sha256": "full30_action_confirmation8_controller_v1.py",
    "release_builder_sha256": (
        "tools/build_full30_action_confirmation8_release_v1.py"
    ),
    "launcher_sha256": (
        "scripts/auh_full30_action_confirmation8_136309_world4_v1.sh"
    ),
    ...
    "resource_136309_specialization_sha256": RESOURCE_SPECIALIZED,
}
ENTRYPOINTS = (
    "full30_action_confirmation8_controller_v1.py",
    "scripts/auh_full30_action_confirmation8_136309_world4_v1.sh",
...
def specialize_resource_bytes(raw: bytes) -> bytes:
    ...
    specialized = raw.replace(b"136141", b"136309")
    if (
        ...
        or specialized.count(b"136309") != 7
        or specialized.replace(b"136309", b"136141") != raw
    ):
        fail("136309 resource specialization postimage differs")
    return specialized
...
def build_manifest(
    ...
    unsigned = {
        ...
        "release_scope": "BOX-EXP-009-confirmation-action-anchor-exact8-only",
        "resource_specialization": {
            ...
            "confirmation_holder_job": 136309,
            "replacement_count": 7,
        ...
        "topology": {
            ...
            "optional_diagnostic_model_invocation_count": 32,
        ...
        "authority": {
            ...
            "diagnostic_branch_count_per_cell": 8,
            ...
            "generated_diagnostic_can_enter_q": False,
            "generated_diagnostic_can_enter_a_min": False,
            "generated_diagnostic_can_enter_optimizer": False,
            "generated_diagnostic_is_admission_prerequisite": False,
...
def validate_manifest(value: Mapping[str, Any]) -> Mapping[str, Any]:
    ...
    if (
        ...
        or authority.get("generated_diagnostic_is_admission_prerequisite")
        is not False
        or authority.get("generated_diagnostic_can_enter_q") is not False
        or authority.get("generated_diagnostic_can_enter_a_min") is not False
        or authority.get("generated_diagnostic_can_enter_optimizer") is not False
        ...
        or topology.get("r10_mp4_gaussian_clean_latent_parity_required")
        is not True
    ):
