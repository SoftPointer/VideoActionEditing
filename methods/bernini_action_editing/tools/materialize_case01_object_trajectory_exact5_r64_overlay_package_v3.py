#!/usr/bin/env python3
"""Seal the r5f-v4 source overlay or materialize its fresh exact-six package.
...
snapshot publication receipt are replayed.  A separate receipt-gated exact6
overlay contributes the new base adapter, composite adapter, evaluator, runner,
launcher, and this materializer.  No byte is read from either burned canary-v1
or failed canary-v2 package.  The output is a new receipt-gated
release25/exact26 HOLD package.
"""
...
RANK_CACHE_ROOT = Path(
    "/tmp/bernini-case01-object-trajectory-exact5-r64-job143808-node292-r3-rank-cache"
)
...
PACKAGE_PUBLICATION_SCHEMA = (
    "case01-object-trajectory-exact5-r64-package-publication-v4"
)
OVERLAY_SCHEMA = "case01-object-trajectory-exact5-r5f-v4-source-overlay-v1"
...
# Stable core-v4 candidate tuple; the package controller remains HOLD until
# this materializer and the fresh exact6 overlay receipt/root coordinates are
# independently audited and pinned.
FINAL_BASE_ADAPTER_SHA256 = "7b72e8dc88d95daa34d93604dddacf6dcf4f75a2f92f356f743183cf06fa7120"
FINAL_RUNNER_SHA256 = "326ccfff1a09d6db8c93d02cfe6018e465e127263547f325cc7f18e7d16a7148"
FINAL_EVAL_SHA256 = "381ba375147bec7580b451226b07b3d1cab9125866978602de05fbba4f16aaa3"
FINAL_WRAPPER_SHA256 = "797c5d1e7cb8bbfda1f2e4cc3825702c248d3ce64770ddc1520155f5635c3557"
FINAL_LAUNCHER_SHA256 = "0315a8630f77e816c3fc5fc9139b8fb72323db59d5d155f85b039ba132cc9b5a"
...
if (
    len(REPLACED_BASE_RELEASE_FILES) != 5
    or not REPLACED_BASE_RELEASE_FILES <= set(BASE_RELEASE_FILES)
    or len(OVERLAY_RELEASE_FILES) != 5
...
def _normalize_overlay_specs(
    ...
    if set(specs) != expected_relatives or len(specs) != 6:
        raise HoldPackageError("overlay exact6 source-name closure differs")
...
def seal_overlay_source_root(
    ...
    """Seal one fresh precreated exact6 overlay and its sibling 0400 receipt."""
    require_overlay_source_pins()
    ...
    try:
        ...
        for relative in sorted(held_files):
            ...
            file_rows.append({
                ...
                "provenance": "fresh_scp_then_held_exact6_seal",
            })
        ...
        value: dict[str, Any] = {
            ...
            "source_file_count": 6, "file_mode": 0o444,
...
def _runtime_identities_from_preflight(
    ...
    internal = {
        "runner": method_prefix + "case01_object_trajectory_exact5_runner_v4.py",
        "legacy_exact5_runner": method_prefix + "case01_source_bone_exact5_runner_v1.py",
        "object_eval": method_prefix + "case01_object_trajectory_exact5_eval_v4.py",
        ...
        "adapter": method_prefix + "infer_case01_object_trajectory_oracle_auh_r5f_v4.py",
        ...
        "base_adapter": method_prefix + "full644_exploratory_matched_infer_adapter_v3.py",
...
def materialize(
    ...
    producer = {
        ...
        "inference_wrapper_path": str(
            method / "infer_case01_object_trajectory_oracle_auh_r5f_v4.py"
        ),
    ...
    report: dict[str, Any] = {
        "schema_version": "case01-object-trajectory-exact5-r64-hold-materialization-v4",
    ...
    report_relative = "authority/package_materialization_receipt_v4.json"
...
def build_parser() -> argparse.ArgumentParser:
    ...
    seal.add_argument(
        ...
        help="exactly six relative=sha256:size source specifications",
    )
