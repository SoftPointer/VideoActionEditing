#!/usr/bin/env python3
"""Materialize the fresh r14 in-allocation WORLD8 release on AUH.
...
EXPECTED = {
    "launcher": (
        "launch_saic_formal_v2_retained_fd_world8_canary_inallocation_r14.py",
        "4df45651a60e5ca65c5109098a0148147da9e00934d68543411c2dc600e659f2",
    ),
    "wrapper": (
        "auh_canary_saic_formal_v2_retained_fd_world8_inallocation_r14.sh",
        "67c160e045d361a9e95604c660a918cc1ec41b7a6a7cbaf24618712c37118f42",
    ),
    "payload": (
        "auh_canary_saic_formal_v2_retained_fd_world8_payload_inallocation_r14.sh",
        "a7a161e03c807a7ba006adb102caf3a2b209dfa20d030fd96a57d823d9568fb8",
    ),
    "postflight": (
        "postflight_saic_formal_v2_retained_fd_world8_canary_inallocation_r14.py",
        "3a80813f4ae23fca457f48920d2dc7de3197b8ba5415bc1fdddb7c20c0366b96",
    ),
}
R10_INPUTS = {
    "runtime": (
...
def die(message: str) -> None:
    raise SystemExit(f"materialize-saic-fv2-fd-world8-inallocation-r14: {message}")
