#!/usr/bin/env python3
"""Materialize the node-local-cache corrected r5e case00 package without Slurm.
...
TARGETS = {
    ...
    / "bernini_full644_exploratory_matched_eval_auh_r5e_job143812_node293_"
...
def _materialize(args: argparse.Namespace) -> dict[str, Any]:
    ...
    report: dict[str, Any] = {
        "schema_version": "full644-exploratory-matched-r5e-case00-materialization-v1",
