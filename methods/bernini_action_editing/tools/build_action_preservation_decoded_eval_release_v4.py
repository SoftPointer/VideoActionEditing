#!/usr/bin/env python3
"""Create/audit the pinned exact15-r3 decoded-eval release.
...
EXPECTED_COMPONENTS: Mapping[str, tuple[str, int, int]] = {
    ...
    "action_preservation_decoded_eval_bridge_v1.py": (
        "91248c78cb03b290b6f12ad4d39bcd0942a21ae3efe8143b3c14ba8e9834cfe4",
        101949,
        0o444,
    ),
...
def _result(value: Mapping[str, Any]) -> dict[str, Any]:
    ...
    row["successor_builder"] = "retained-fd-model-authority-producer-audit-v4"
    return row
