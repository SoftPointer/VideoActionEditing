#!/usr/bin/env python3
"""Stdlib-only external verifier/snapshot builder for v15c-r8 local release.
...
class BootstrapV15CR8Error(RuntimeError):
    """The external trust root, release closure, or snapshot differs."""


BootstrapV15CR7Error = BootstrapV15CR8Error
