#!/usr/bin/env python3
"""Role-explicit adapter and tensor primitives for source-self repaint.
...
SCHEMA_VERSION = "bernini-source-self-role-repaint-adapter-v1"
...
class RouteInvocation:
    ...
    def __post_init__(self) -> None:
        ...
        if size not in {1, 4}:
            raise SourceSelfRoleRepaintError("only SP1 tests and SP4 AUH are supported")
