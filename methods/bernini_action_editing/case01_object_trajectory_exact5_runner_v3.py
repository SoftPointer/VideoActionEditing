#!/usr/bin/env python3
"""Five-arm v3 composite object-trajectory runner on the frozen exact5 chain.
...
FAILURE_SCHEMA = "case01-object-trajectory-exact5-runner-failure-v3"
PHYSICAL_BINDINGS_SCHEMA = "case01-object-trajectory-exact5-physical-bindings-v3"
_LEGACY_BASENAME = "case01_source_bone_exact5_runner_v1.py"
_EVAL_BASENAME = "case01_object_trajectory_exact5_eval_v3.py"
...
def execute(args: Any) -> dict[str, Any]:
    ...
    identities = {
        ...
        "object_wrapper_inner": frozen._identity(
            producer["object_wrapper_inner_path"],
    ...
    if (
        ...
        != Path(producer["object_wrapper_inner_path"]).resolve(
            strict=True
        ).parent
        or adapter_path.parent
    ...
    try:
        ...
        bindings: dict[str, Any] = {
            ...
            "producer_roles_distinct": {
                ...
                "composite_inner_and_legacy_hashes_distinct": (
                    len({
