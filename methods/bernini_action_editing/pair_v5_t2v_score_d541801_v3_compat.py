#!/usr/bin/env python3
"""Pinned d541801 compatibility boundary for formal PAIR-v5 T2V v3 scores.

The active repository may contain later action-energy arithmetic experiments.
Those experiments are not calibration-compatible with the already rendered
and scored d541801 bank.  This module therefore provides two deliberately
narrow facilities:
...
It never accepts a v4 receipt or Decimal action scalar on the formal path.
"""
...
V3_SCALAR_DEFINITION = "d541801_live_fp32_log_difference_first_argmin"
