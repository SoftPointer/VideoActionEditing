...
import diagnose_saic_partial33_source_bound_dinov2_same_actor_all_three_negatives_raw_v1 as diagnostic
...
class R5Exact33AllThreeSameActorRawContractTest(unittest.TestCase):
    ...
    def test_main_restores_both_nested_module_layers_and_self_identity(self) -> None:
        source_sha256 = (
            "ed6d1dd567a4fde84b7335ec53237311b6aae3a30e24e799d3eadf649294e5c3"
        )
        for module in (diagnostic.frozen, diagnostic.core):
            module.__file__ = "/tmp/polluted-r5-source.py"
        ...
        for module in (diagnostic.frozen, diagnostic.core):
            ...
            self.assertEqual(module.EXPECTED_ATTEMPT_COUNT, 33)
    ...
    def test_pins_counts_policy_and_required_legacy_source(self) -> None:
        ...
        self.assertEqual(diagnostic.EXPECTED_CANDIDATE_NEGATIVE_PAIR_COUNT, 99)
        ...
        self.assertEqual(len(diagnostic.EXPECTED_MISSING_CORRECT_SOURCE_IIDS), 3)
        self.assertEqual(
            diagnostic.EXPECTED_LEGACY_CYCLIC_AGGREGATE_SHA256,
            "2f85ca48b9338920f050bc7b6bfe222b7e324087fc6ff99ff020a9a3c600092c",
        )
    ...
    def test_real_schema_manifest_roundtrip_distinguishes_15_executed_from_24_registered(self) -> None:
        ...
        self.assertEqual(len(loaded["attempts"]), 33)
        self.assertEqual(sum(len(row["negative_sources"]) for row in loaded["attempts"]), 99)
    ...
    def test_exact8_cache_and_operational_fd_gap_are_explicit(self) -> None:
        ...
        self.assertIn("all_33_legacy_cyclic_raw_metrics_exact", source)
    ...
    def test_launcher_is_owned_exact8_and_requires_regression_input(self) -> None:
        launcher = (
            METHOD_ROOT
            / "scripts"
            / "auh_diagnose_saic_partial33_source_bound_dinov2_same_actor_all_three_negatives_raw_v1.sh"
        ).read_text("utf-8")
