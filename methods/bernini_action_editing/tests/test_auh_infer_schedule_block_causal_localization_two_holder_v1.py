...
class ScheduleBlockCausalLocalizationTwoHolderControllerTests(unittest.TestCase):
    ...
    def test_frozen_release_runtime_and_core_pins_are_exact_nonzero(self) -> None:
        ...
        for line in (
            "readonly expected_runtime_sha=913272f2d8c55dd0d07ebae26fb17788b82f95955b38421b1d9d5ae48b21ed1f",
            "readonly expected_core_sha=385cc2321da888f75d5aff5017175b85acf06174969aaa39210b802cc14695c5",
            "readonly expected_release_archive_sha=f7834f6b301c24613a160774e0b98fc5e37e797ab3cd475fe904d8012c1ff587",
            "readonly expected_release_manifest_sha=c793e8cde0ef099ee342b523025cf745384957d725affe1580e2119331708613",
            "readonly expected_release_revision=a3ec54fb6a9acf43270a5d5070a53b2d9bd94250",
        ):
    ...
    def test_formal_118_output_postflight_heredoc_executes(self) -> None:
        ...
        with tempfile.TemporaryDirectory(prefix="stagea-postflight-", dir="/tmp") as directory:
            ...
            receipt["method_source"] = {
                "revision": "a3ec54fb6a9acf43270a5d5070a53b2d9bd94250",
                "archive_sha256": "f7834f6b301c24613a160774e0b98fc5e37e797ab3cd475fe904d8012c1ff587",
            }
            ...
            args = [
                ...
                "f7834f6b301c24613a160774e0b98fc5e37e797ab3cd475fe904d8012c1ff587",
                "c793e8cde0ef099ee342b523025cf745384957d725affe1580e2119331708613",
                "a3ec54fb6a9acf43270a5d5070a53b2d9bd94250",
