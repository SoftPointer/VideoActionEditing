...
SCRIPT = (
    ...
    / "scripts"
    / "auh_stage_b_t0_matched_decode_20260824_v4.sh"
)


class MatchedDecodeV4LauncherStaticTests(unittest.TestCase):
    @classmethod
    ...
    def test_v4_has_fresh_immutable_coordinates(self) -> None:
        self.assertIn("source_stage_b_t0_decode_v4", self.source)
        self.assertIn("matched_decode_v4/0be6494dfac3", self.source)
        self.assertIn("logs/stage_b_t0_retry8/matched_decode_v4", self.source)
        self.assertNotIn("source_stage_b_t0_decode_v3", self.source)
        self.assertNotIn("matched_decode_v3/0be6494dfac3", self.source)

    def test_binds_fixed_parser_runner_and_test(self) -> None:
        self.assertIn(
            "6b41d250acc44dc868a708a36bd9b73bfb6b3cd96391e1730f196d008cc2d38d",
            self.source,
        )
        self.assertIn(
            "98713ea12a3701b1fccf23b2acc80e0e9102fa0c44142152f8ba8a6898dcc3e5",
            self.source,
        )
