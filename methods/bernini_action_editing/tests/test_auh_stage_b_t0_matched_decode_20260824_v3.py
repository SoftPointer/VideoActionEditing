...
SCRIPT = (
    ...
    / "scripts"
    / "auh_stage_b_t0_matched_decode_20260824_v3.sh"
)


class MatchedDecodeV3LauncherStaticTests(unittest.TestCase):
    @classmethod
    ...
    def test_v3_has_fresh_immutable_coordinates(self) -> None:
        self.assertIn("source_stage_b_t0_decode_v3", self.source)
        self.assertIn("matched_decode_v3/0be6494dfac3", self.source)
        self.assertIn("logs/stage_b_t0_retry8/matched_decode_v3", self.source)
        self.assertNotIn("source_stage_b_t0_decode_v2", self.source)
        self.assertNotIn("matched_decode_v2/0be6494dfac3", self.source)

    def test_binds_fixed_parser_runner_and_test(self) -> None:
        self.assertIn(
            "1f86b174306fdc2fc711f9f5bb0e99cfc814f79468b9470c5e8181c5b0badf5d",
            self.source,
        )
        self.assertIn(
            "4e56ea045d5743e31caeaac7adb7a43049e31bf339b6266da563a9604af42c20",
            self.source,
        )
