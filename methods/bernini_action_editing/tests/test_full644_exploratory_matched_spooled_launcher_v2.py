...
import full644_exploratory_matched_spooled_launcher_v2 as launcher
...
expected_environment={"FULL644_MATCHED_CAPTURED_RUNNER_ENTRY_AUTHORITY","SLURM_JOB_ID","SLURM_STEP_ID","SLURM_GPUS_ON_NODE","SLURM_JOB_GPUS","SLURM_STEP_GPUS","SLURM_JOB_NUM_NODES"}
...
class SpooledLauncherV2Tests(unittest.TestCase):
    def test_production_source_pins_match_current_repo_bytes(self) -> None:
        sources = {
            "runner": "full644_exploratory_matched_runner_v2.py",
    ...
    def test_payload_hard_pins_release_and_forbids_named_execution(self) -> None:
        with tempfile.TemporaryDirectory() as raw:
            ...
            self.assertIn("if len(sys.argv)!=12", launcher.ROOT_BOOTSTRAP)
