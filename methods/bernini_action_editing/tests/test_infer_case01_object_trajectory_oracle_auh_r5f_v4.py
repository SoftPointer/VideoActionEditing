...
BASE_V3_SOURCE = METHOD_ROOT / "full644_exploratory_matched_infer_adapter_v3.py"
R5F_SOURCE = (
...
class CompositeR5FV4Tests(unittest.TestCase):
    @classmethod
    def setUpClass(cls) -> None:
        ...
        shutil.copy2(BASE_V3_SOURCE, cls.release_root / BASE_V3_SOURCE.name)
        (cls.release_root / BASE_V3_SOURCE.name).chmod(0o444)
        ...
        local_names = {
            ...
            "_case01_object_trajectory_r5f_v4_test",
    ...
    def test_source_compiles_and_r5f_authority_core_is_unchanged(self) -> None:
        ...
        self.assertEqual(self.composite.BASE_ADAPTER_SHA256, _sha(BASE_V3_SOURCE))
        self.assertEqual(
            self.composite._BASE_ADAPTER_PATH.name,
