#!/usr/bin/env python3
"""Hostile tests for the fresh receipt-gated exact5 GPU controller v6 HOLD."""
...
CONTROLLER_PATH = ROOT / (
    ...
    "auh_launch_case01_object_trajectory_exact5_r64_gpu_once_v6.HOLD.py"
)
CONTROLLER_READY_PATH = CONTROLLER_PATH.with_name(
    "auh_launch_case01_object_trajectory_exact5_r64_gpu_once_v6.READY.py"
)
STATIC_PATH = ROOT / (
    "methods/bernini_action_editing/scripts/"
...
controller = load(CONTROLLER_PATH, "_case01_gpu_controller_v6_test")
ready_controller = load(
    CONTROLLER_READY_PATH, "_case01_gpu_controller_v6_ready_test",
)
...
class GPUControllerSourceTests(unittest.TestCase):
    def test_ready_is_exact_single_state_projection_of_frozen_hold(self):
        ...
        self.assertEqual(
            ...
            "139b3bdb44ac62d94cbbb60a9e6e69c0641cd6e13c60bf28b93a185156ebc377",
        )
    ...
    def test_static_v6_boundary_forbids_old_producer_authorities(self):
    ...
    def test_revoked_gpu_v4_v5_outer_namespace_is_absent_gate_not_input(self):
        active = {
        ...
        self.assertTrue(all("v6" in path.name for path in active))
    ...
    def test_scientific_v3_custom_v4_off_v5_outer_v6_abi_split(self):
        ...
        self.assertEqual(controller.SCHEMA,
                         "case01-object-trajectory-exact5-r64-gpu-controller-v6")
        self.assertEqual(
        ...
        self.assertTrue(controller.ATTEMPT_PATH.name.endswith("_v6.json"))
        self.assertTrue(controller.EVIDENCE_PATH.name.endswith("_v6.json"))
...
class ProducerAlignmentTests(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.cpu = load(COMPOSITE_CPU_GATE_PATH, "_case01_gpu_v6_cpu_gate")
        cls.cpu_ready = load(
            COMPOSITE_CPU_GATE_READY_PATH,
            "_case01_gpu_v6_cpu_gate_ready",
        )
