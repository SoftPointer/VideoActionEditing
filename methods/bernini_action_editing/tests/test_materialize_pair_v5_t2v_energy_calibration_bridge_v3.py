...
CPU_LAUNCHER = (
    METHOD_ROOT
    / "scripts"
    / "auh_materialize_pair_v5_t2v_energy_calibration_bridge_v3_cpu.sbatch"
)
...
import materialize_pair_v5_t2v_energy_calibration_bridge_v3 as bridge  # noqa: E402
        ...
        result.append(
            {
                ...
                "score_receipt_files": [],
                "frozen_scorer_authority": {"authority": "fixture"},
            }
        )
    return result
