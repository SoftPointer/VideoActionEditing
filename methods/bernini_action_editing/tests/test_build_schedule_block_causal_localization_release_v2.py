...
from methods.bernini_action_editing.tools import (
    build_schedule_block_causal_localization_release_v2 as release,
)
...
class ScheduleBlockReleaseSourceStaticTests(unittest.TestCase):
    def test_preserved_runtime_and_test_freezes_are_exact(self) -> None:
        ...
        self.assertEqual(
            ...
            "4df78b5ed77a1efde333efd0de65e2a031de8685dbb3c9ebc723cc5d6fcc4f3d",
        )

    def test_v1_builder_test_and_release_bytes_are_preserved(self) -> None:
        expected = {
    ...
    def test_v2_builder_logic_is_byte_equivalent_after_pin_normalization(self) -> None:
        ...
        normalized = (
            current.replace(
                ...
                'SCHEMA_VERSION = "bernini-schedule-block-causal-localization-release-v1"',
            )
            .replace('RELEASE_GENERATION = "r2"', 'RELEASE_GENERATION = "r1"')
            .replace(
                "31a32125c11a36104b233a6ab271026add82478cdcb3144331fef6ad1e5f3b05",
                "913272f2d8c55dd0d07ebae26fb17788b82f95955b38421b1d9d5ae48b21ed1f",
            )
        )
        self.assertEqual(normalized, V1_BUILDER.read_text(encoding="utf-8"))
...
class ScheduleBlockCausalLocalizationReleaseTests(unittest.TestCase):
    ...
    def test_exact_diagnostic_release_is_deterministic(self) -> None:
        ...
        self.assertEqual(manifest["release_generation"], "r2")
