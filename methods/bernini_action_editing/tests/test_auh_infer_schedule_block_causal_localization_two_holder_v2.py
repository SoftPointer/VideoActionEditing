...
class ScheduleBlockCausalLocalizationTwoHolderControllerTests(unittest.TestCase):
    ...
    def test_v1_controller_and_test_bytes_are_preserved(self) -> None:
        self.assertEqual(
    ...
    def test_v2_safety_and_cli_logic_are_byte_equivalent_after_pin_normalization(self) -> None:
        normalized = (
            self.source.replace(
            ...
            .replace(
                ...
                "auh_infer_schedule_block_causal_localization_two_holder_v1.sh",
            )
            .replace(
            ...
            .replace(
                ...
                'value["release_generation"]=="r1"',
            )
        )
        self.assertEqual(normalized, V1_CONTROLLER.read_text(encoding="utf-8"))
    ...
    def test_formal_118_output_postflight_heredoc_executes(self) -> None:
        ...
        with tempfile.TemporaryDirectory(prefix="stagea-postflight-", dir="/tmp") as directory:
            ...
            receipt["method_source"] = {
                "revision": "7ced6fc99f00c728af477e07cdd58a9e239e973c",
                "archive_sha256": "1d9d4eb37aedffc13d0e1aaf0663561ae989aeb15a42e52437ea4a0dd9287a9f",
            }
