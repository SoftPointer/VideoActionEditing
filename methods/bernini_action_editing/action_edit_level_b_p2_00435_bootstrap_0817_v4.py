...
LEVEL_B_RELEASE_ROOT = (
    EXPERIMENT_ROOT / "releases" / "fresh-world8-level-b-p2-00435-v3"
)
...
STATIC_PREFLIGHT_STDOUT_SHA256 = "68edb1c3d5925d5ef26a2601b989f91777da3be4ad03d772aa5c2c7f1dde7998"
STATIC_PREFLIGHT_STDOUT_SIZE = 29205
STATIC_PREFLIGHT_PASS_TOKEN = "LEVEL_B_P2_00435_V4_CPU_STATIC_PREFLIGHT_OK"
...
OUTPUT_MP4 = (
    ...
    / "runs"
    / TAG
    / "00435ad621c44fac_p2_seed2026080821_v4.mp4"
)
...
def static_preflight() -> Mapping[str, Any]:
    ...
    unsigned = {
        "schema_version": "bernini-action-edit-level-b-p2-cpu-static-preflight-v4",
        "method": METHOD,
        "authority": AUTHORITY,
        "tag": TAG,
...
def validate_product() -> Mapping[str, Any]:
    ...
    return {
        "schema_version": "bernini-action-edit-level-b-p2-product-validation-v4",
        "method": METHOD,
        "authority": AUTHORITY,
