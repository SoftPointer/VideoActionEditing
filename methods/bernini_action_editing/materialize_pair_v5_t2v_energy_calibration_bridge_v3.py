#!/usr/bin/env python3
"""Bridge sealed core4-v2 T2V scores to detached v3 calibration receipts.
...
``pair_v5_t2v_energy_calibration_v3``.
...
import author_pair_v5_core4_event_labels_v3 as label_author  # noqa: E402
import pair_v5_t2v_energy_calibration_v3 as calibration  # noqa: E402


BRIDGE_SCHEMA = "bernini-pair-v5-core4-v2-energy-calibration-bridge-receipt-v3"
CALIBRATOR_ID = "pair5-t2v-core4-v2-global-energy-v3"
SCORE_FILENAME = "pair-v5-t2v-global-energy-score-v4.json"
GROUP_FILENAME = "pair-v5-t2v-global-energy-{group_id}-v4.json"
...
def validate_score_group_receipt(
    ...
    *,
    ...
    if (
        ...
        or row["schema_version"] != scorer.GROUP_RECEIPT_SCHEMA
...
def validate_bridge_receipt(value: Any) -> dict[str, Any]:
    ...
    if (
        ...
        != [
            digest
            for group in root["score_group_receipts"]
...
def materialize(
    *,
    ...
    _write_create_only(
        output / "pair-v5-t2v-energy-calibration-bridge-receipt-v3.json",
        bridge_receipt,
    )
