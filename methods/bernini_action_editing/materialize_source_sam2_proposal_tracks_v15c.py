...
EXPECTED_SPEC_RAW_SHA256 = (
    "fe6dc44d013fe730291fc58954886d41119f3409b2af873b3d82c4d05177b9f5"
)
EXPECTED_SPEC_CANONICAL_SHA256 = (
    "f90e7e7517a5ad23fb4d11ce6eea5326d94142dc883d4b2cfea28e289c0597c3"
)
...
def validate_spec(value: Any) -> None:
    ...
    if (
        ...
        or execution != {
            ...
            "sealed_code_snapshot_member_count": 8,
            "sealed_code_snapshot_directory_mode": "0700",
            "python_flags": ["-E", "-s", "-B"],
