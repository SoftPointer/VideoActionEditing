#!/usr/bin/env python3
"""Metadata gate for the fresh r5g Shared8 full16 package.
...
SCHEMA = "full644-exploratory-matched-r5g-full16-static-nomodel-probe-v1"
...
def validate_input(value: Mapping[str, Any], root: Path, plan: Path) -> None:
    ...
    if (
        ...
        or value.get("output_report") != str(root / "final/full16_report_auh_r5.json")
...
def _publish(path: Path, value: Mapping[str, Any]) -> None:
    ...
    try:
        ...
        sentinel = f"R5G_FULL16_STATIC_NOMODEL_PASS {value['receipt_digest']}\n".encode("ascii")
