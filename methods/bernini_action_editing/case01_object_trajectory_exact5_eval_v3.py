#!/usr/bin/env python3
"""Fail-closed v3 composite plan/receipt contract for trajectory exact-five.
...
SCHEMA_VERSION = "case01-object-trajectory-exact5-plan-v3"
...
EXPERIMENT_ID = "case01-288545b9c031491a-object-trajectory-exact5-v3"
...
EXPECTED_INFERENCE_WRAPPER_SIZE = 42_184
...
EXPECTED_PRODUCER_BASENAMES = {
    ...
    "object_wrapper_inner_path": "infer_case01_object_trajectory_oracle_v1.py",
...
def _validate_producer(value: Mapping[str, Any], *, require_complete: bool, reopen: bool) -> dict[str, Any]:
    ...
    pin_triples = (
        ...
        (
            "object_wrapper_inner_path", "object_wrapper_inner_sha256",
            "object_wrapper_inner_size",
        ),
        (
            "trajectory_projection_module_path",
...
def incomplete_producer() -> dict[str, Any]:
    ...
    return {
        ...
        "object_wrapper_inner_path": (
            PLACEHOLDER_PREFIX + "OBJECT_TRAJECTORY_WRAPPER_INNER_PATH__"
        ),
        "object_wrapper_inner_sha256": EXPECTED_OBJECT_WRAPPER_INNER_SHA256,
        "object_wrapper_inner_size": EXPECTED_OBJECT_WRAPPER_INNER_SIZE,
...
def _expected_oracle_producer_hashes(
    ...
    return {
        ...
        "object_wrapper_inner_source_sha256": producer[
            "object_wrapper_inner_sha256"
        ],
