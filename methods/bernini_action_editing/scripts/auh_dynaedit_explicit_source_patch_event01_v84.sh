...
case "$host:$gpu_group" in
  auh7-1b-gpu-246:0)
    label=NATIVE_EXPLSRC_ID000_PATCHV_A100_ALL40_B4_9_P24_R8
    identity_strength=0.0
    blocks=4-9
    ;;
  auh7-1b-gpu-246:1)
    label=NATIVE_EXPLSRC_ID075_PATCHV_A100_ALL40_B4_9_P24_R8
    identity_strength=0.075
    blocks=4-9
    ;;
  auh7-1b-gpu-247:0)
    label=NATIVE_EXPLSRC_ID000_PATCHV_A100_ALL40_B8_13_P24_R8
    identity_strength=0.0
    blocks=8-13
    ;;
  auh7-1b-gpu-247:1)
    label=NATIVE_EXPLSRC_ID075_PATCHV_A100_ALL40_B8_13_P24_R8
    identity_strength=0.075
    blocks=8-13
    ;;
  *)
    echo "Round 84 is restricted to GPU groups 0/1 on nodes 246/247" >&2
    exit 3
    ;;
esac

stage=/vast/users/guangyi.chen/causal_group/peiyuan.zhu/work/VideoEditing/VideoEdit_experiments/action_flow_noise_stage0_job140846_v1/stage1
source_tree="$stage/anchor_qk_explicit_source_v1"
export DEV_OVERRIDE="$source_tree"
export LABEL_OVERRIDE="$label"
export OUTPUT_ROOT_OVERRIDE="$stage/dynaedit_explicit_source_patch_event01_v84"
