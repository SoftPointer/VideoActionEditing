...
case "$host:$gpu_group" in
  auh7-1b-gpu-246:0)
    label=NATIVE_SOURCEPATCH_VALUE_A100_ALL40_B4_9_ACTOROBJ_P24_R8
    strength=1.0
    blocks=4-9
    ;;
  auh7-1b-gpu-246:1)
    label=NATIVE_SOURCEPATCH_VALUE_A050_ALL40_B4_9_ACTOROBJ_P24_R8
    strength=0.5
    blocks=4-9
    ;;
  auh7-1b-gpu-247:0)
    label=NATIVE_SOURCEPATCH_VALUE_A100_ALL40_B8_13_ACTOROBJ_P24_R8
    strength=1.0
    blocks=8-13
    ;;
  auh7-1b-gpu-247:1)
    label=NATIVE_SOURCEPATCH_VALUE_A050_ALL40_B8_13_ACTOROBJ_P24_R8
    strength=0.5
    blocks=8-13
    ;;
  *)
    echo "Round 82 is restricted to GPU groups 0/1 on nodes 246/247" >&2
    exit 3
    ;;
esac
...
export OUTPUT_ROOT_OVERRIDE="$stage/dynaedit_source_patch_value_event01_v82"
