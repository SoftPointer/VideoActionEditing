...
case "$host" in
  auh7-1b-gpu-246)
    label=NATIVE_TRAJ_HARDQK_EARLY3_B4_9_ENDPOINTSGA
    transport=hard_qk
    ;;
  auh7-1b-gpu-247)
    label=NATIVE_TRAJ_HARDK_EARLY3_B4_9_ENDPOINTSGA
    transport=hard_k
    ;;
  *)
    echo "Round 51 is restricted to Job 140846 nodes 246-247" >&2
    exit 3
    ;;
esac
...
export OUTPUT_ROOT_OVERRIDE="$stage/dynaedit_native_t2v_hard_attention_event01_v51"
...
# A four-GPU Slurm step exposes its assigned quartet as local ordinals 0..3.
