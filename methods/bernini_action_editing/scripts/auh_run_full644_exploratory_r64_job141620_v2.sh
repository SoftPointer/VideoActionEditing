...
readonly capacity_output="${experiment_root}/runs/prelaunch-capacity-sft-r64-step1-v2"
readonly full644_output="${experiment_root}/runs/full644-r64-reference-dpo-preservation-one-pass-v2"
...
readonly run_mode="$1"
output="$(output_for_mode "${run_mode}")" || fail "mode output resolution failed"
readonly output
