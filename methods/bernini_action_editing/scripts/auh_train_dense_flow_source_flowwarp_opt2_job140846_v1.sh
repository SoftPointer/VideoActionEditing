...
source_tree="$root/stage1/source-78fcf8b-overlay"
...
output="$root/stage1/opt2_${flow_tag}_midlate_t${max_timestep}_${preservation_tag}_lr1e4_sr50_s80_r1"
scratch="/tmp/flowwarp-opt2-${flow_tag}-t${max_timestep}-${preservation_tag}-g${gpu_group}-140846-${SLURM_STEP_ID:-ssh}"
...
"$python_bin" -B -m torch.distributed.run --standalone --nproc_per_node=4 \
  ...
  --seed 2026081705 \
  --max-grad-norm 10 \
  --method-source-revision 78fcf8b08bb44922958e84caa39170bf869bdfa3 \
  --method-source-archive-sha256 9b01601bffe9113c33d2243baf7f65042bb25fedf3d66d8e9285f7a6e0cfbbb0
