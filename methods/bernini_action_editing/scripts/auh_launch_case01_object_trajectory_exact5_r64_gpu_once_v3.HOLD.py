#!/usr/bin/env python3
"""Fresh-v3 receipt-gated one-shot GPU controller for exact-five.
...
SCHEMA = "case01-object-trajectory-exact5-r64-gpu-controller-v3"
...
CONTROLLER_STATE = "HOLD_PENDING_FRESH_PACKAGE_AND_COMPOSITE_CPU_PINS"
...
MATERIALIZATION_REPORT_PATH = (
    PACKAGE_ROOT / "authority/package_materialization_receipt_v3.json"
)
PACKAGE_CONTROLLER_EVIDENCE_PATH = EXPERIMENTS / (
    "bernini_case01_object_trajectory_exact5_r64_canary_v2."
    "materialize_controller_evidence_v2.json"
)
COMPOSITE_CPU_RECEIPT_PATH = EXPERIMENTS / (
    "bernini_case01_object_trajectory_exact5_r64_canary_v2."
    "composite_cpu_admission_receipt_v1.json"
)
COMPOSITE_CPU_EVIDENCE_PATH = EXPERIMENTS / (
    "bernini_case01_object_trajectory_exact5_r64_canary_v2."
    "composite_cpu_admission_controller_evidence_v1.json"
)
HOLD_PLAN_PATH = (
...
RUNTIME_RECEIPT_PATH = PACKAGE_ROOT / "runtime/exact5_gpu_runtime_v3.json"
RANK_CACHE_RECEIPT_PATH = (
    PACKAGE_ROOT / "runtime/exact5_gpu_rank_cache_receipt_v3.json"
)
ATTEMPT_PATH = PACKAGE_ROOT / "evidence/exact5_gpu_attempt_v3.json"
DISPATCH_PATH = PACKAGE_ROOT / "evidence/exact5_gpu_dispatch_v3.json"
EVIDENCE_PATH = PACKAGE_ROOT / "evidence/exact5_gpu_controller_receipt_v3.json"
STDOUT_PATH = PACKAGE_ROOT / "logs/exact5_gpu_srun_v3.stdout.log"
STDERR_PATH = PACKAGE_ROOT / "logs/exact5_gpu_srun_v3.stderr.log"
OUTPUT_REPORT_PATH = (
...
RANK_CACHE_ROOT = Path(
    "/tmp/bernini-case01-object-trajectory-exact5-r64-job143808-node292-r2-"
    "rank-cache"
)
...
COMPOSITE_CPU_SCHEMA = (
    "case01-object-trajectory-exact5-r5f-v3-composite-cpu-admission-v1"
)
COMPOSITE_CPU_EVIDENCE_SCHEMA = (
    "case01-object-trajectory-exact5-r5f-v3-composite-cpu-controller-v1"
)
...
PACKAGE_PUBLICATION_RECEIPT_SHA256 = (
    "9b1baad3b61eeb944883b8f58650d3d49a3c36361f80aa83e093397794b89dec"
)
PACKAGE_PUBLICATION_RECEIPT_SIZE: int | str = 2_530
PACKAGE_PUBLICATION_RECEIPT_DIGEST = (
    "b1ab8c66840667ec728cb4aa345f6bdaee0c8725b5249ab8054a233f56e82ad0"
)
MATERIALIZATION_REPORT_SHA256 = (
    "f6102c90330da290bcac130f4654e476fade0ca23953dccb5981f728979bd828"
)
MATERIALIZATION_REPORT_SIZE: int | str = 41_351
MATERIALIZATION_REPORT_DIGEST = (
    "1bfdf6feff9bfec8fdd5cd639313783c33438339637b69d99663ff74cdbf49c3"
)
PACKAGE_CONTROLLER_EVIDENCE_SHA256 = (
    "8820c7669dceac6ccb2cc141388f749eed1e292ee0ce5815d3ebb9ccb4d05cf5"
)
PACKAGE_CONTROLLER_EVIDENCE_SIZE: int | str = 8_113
PACKAGE_CONTROLLER_EVIDENCE_DIGEST = (
    "10b518de66e597889075b129fa11ca93c0cfa26f9d14d71627ad568b674f88f6"
)
PACKAGE_ROOT_IDENTITY: list[int] | str = [
    48, 11191717629266469342, 2012, 2000, 16832, 2, 0, 4096, 0,
    1787370343768795249, 1787370344144021529,
]
...
SEALED_HOLD_PLAN_SHA256 = (
    "751f4f02dcbe237ef6b88877c0dd9452ede150fbb35c982b56d55b396f09bd16"
)
SEALED_HOLD_PLAN_SIZE: int | str = 32_050
SEALED_HOLD_PLAN_DIGEST = (
    "6feb5c05ad724586a3feb5f8d6d369d6c74b0ca515bda25831294fe486e15e4f"
)
SEALED_LAUNCH_INPUT_SHA256 = (
    "79d8f34d04652eaa0ace13af31a29575260d91d72c3bfc532a71e2d9c79b5124"
)
SEALED_LAUNCH_INPUT_SIZE: int | str = 9_788
NAMED_HOLD_PAYLOAD_SHA256 = (
    "cc9868f0631bba8308c1fa6cd7dfac64dc730270ab53c782f8e4089655f13a09"
)
...
COMPOSITE_CPU_RECEIPT_SHA256 = (
    "f36e56bc6fdcd11d29b5bb4f5a4144c7338afc40f1c09f73163c0f40efd84f69"
)
COMPOSITE_CPU_RECEIPT_SIZE: int | str = 6_082
COMPOSITE_CPU_RECEIPT_DIGEST = (
    "ba3dcfa0bd8ca388042a1a2ecb5e7bbef4b4592c7963c6c0f034ab0f66e624d6"
)
COMPOSITE_CPU_EVIDENCE_SHA256 = (
    "b5fe98c05553b634ce5ac0086efa34cdf53ec22462083e904007c6ede7183c44"
)
COMPOSITE_CPU_EVIDENCE_SIZE: int | str = 1_849
COMPOSITE_CPU_EVIDENCE_DIGEST = (
    "436a76042baed6205d0dacbb5e494c79b6f7bbf2c78c514892bd0000c68009ab"
)
...
def validate_composite_cpu_admission(
    ...
    receipt_fields = {
        ...
        "slurm_step_id", "package", "world_size", "rank_count",
        "rank_rows", "isolated_runtime", "private_parent_fd",
        "shared_ofd_pread", "module_binding", "side_effects",
        "cache_lifecycle", "process_cleanup", "launch_allowed",
        "receipt_digest",
    }
    ...
    if (
        ...
        or receipt.get("status") != "PASS_COMPOSITE_CPU_EXACT26_HOLD"
        ...
        or receipt.get("cache_lifecycle") != {
            "admission_cache_root": (
                "/tmp/bernini-case01-object-trajectory-r5f-v3-composite-cpu-"
    ...
    rank_fields = {
        ...
        "pread_offset_before", "pread_offset_after", "rank_digest",
    }
    for index, row in enumerate(rows):
        if type(row) is not dict or set(row) != rank_fields:
        ...
        if (
            ...
            or type(row.get("pread_offset_before")) is not int
            or row.get("pread_offset_after") != row["pread_offset_before"]
    ...
    evidence_fields = {
        "schema_version", "status", "holder_job_id", "node",
        "slurm_step_id", "single_srun_attempt", "retry_allowed",
        "srun_count", "srun_ntasks", "real_rank_process_count",
        "cpus_per_task", "gpu_count",
    ...
    if (
        ...
        or evidence.get("status") != "PASS_COMPOSITE_CPU_CONTROLLER"
        ...
        or type(evidence.get("cpus_per_task")) is not int
        or evidence["cpus_per_task"] <= 0
...
if (type(release) is not dict or set(release)!=fields or release_raw!=canonical(release) or digest(release)!=release_digest
 or release.get("schema_version")!="case01-object-trajectory-exact5-r64-gpu-release-v3" or release.get("entry_mode")!="trusted_controller_streamed_stdin"
 ...
 or release.get("rank_cache_root")!="/tmp/bernini-case01-object-trajectory-exact5-r64-job143808-node292-r2-rank-cache"):
...
if argmap["--output-report"]!=os.path.join(expected_dirs["final"],"object_trajectory_exact5_report_v3.json") or release["runner_attestation_path"]!=os.path.join(expected_dirs["final"],"object_trajectory_exact5_runner_attestation_v3.json") or release["runtime_receipt_path"]!=os.path.join(expected_dirs["runtime"],"exact5_gpu_runtime_v3.json") or release["rank_cache_receipt_path"]!=os.path.join(expected_dirs["runtime"],"exact5_gpu_rank_cache_receipt_v3.json"): raise RuntimeError("compute target path closure differs")
...
def build_production_release(
    ...
    release: dict[str, Any] = {
        "schema_version": "case01-object-trajectory-exact5-r64-gpu-release-v3",
...
def build_srun_argv(max_gate_step: int) -> list[str]:
    ...
    return [
        ...
        "--job-name=case01-object-trajectory-exact5-r64-gpu-v3",
