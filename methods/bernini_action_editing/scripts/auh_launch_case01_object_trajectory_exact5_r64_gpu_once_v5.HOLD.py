#!/usr/bin/env python3
"""Fresh-v5 receipt-gated one-shot GPU controller for exact-five.
...
SCHEMA = "case01-object-trajectory-exact5-r64-gpu-controller-v5"
...
CONTROLLER_STATE = "HOLD_PENDING_FRESH_V3_COMPOSITE_CPU_PINS"
...
ATTEMPT_PATH = PACKAGE_ROOT / "evidence/exact5_gpu_attempt_v5.json"
DISPATCH_PATH = PACKAGE_ROOT / "evidence/exact5_gpu_dispatch_v5.json"
EVIDENCE_PATH = PACKAGE_ROOT / "evidence/exact5_gpu_controller_receipt_v5.json"
STDOUT_PATH = PACKAGE_ROOT / "logs/exact5_gpu_srun_v5.stdout.log"
STDERR_PATH = PACKAGE_ROOT / "logs/exact5_gpu_srun_v5.stderr.log"
...
if (
    ...
    & set(REVOKED_COMPOSITE_CPU_V2_PATHS)
    or {COMPOSITE_CPU_SCHEMA, COMPOSITE_CPU_EVIDENCE_SCHEMA}
    & REVOKED_COMPOSITE_CPU_V2_SCHEMAS
):
    raise RuntimeError("revoked composite CPU-v2 authority reappeared")
...
COMPOSITE_CPU_RECEIPT_SHA256 = (
    "BLOCKED_PENDING_FRESH_V3_COMPOSITE_CPU_RECEIPT_SHA256"
)
COMPOSITE_CPU_RECEIPT_SIZE: int | str = (
    "BLOCKED_PENDING_FRESH_V3_COMPOSITE_CPU_RECEIPT_SIZE"
)
COMPOSITE_CPU_RECEIPT_DIGEST = (
    "BLOCKED_PENDING_FRESH_V3_COMPOSITE_CPU_RECEIPT_DIGEST"
)
COMPOSITE_CPU_EVIDENCE_SHA256 = (
    "BLOCKED_PENDING_FRESH_V3_COMPOSITE_CPU_EVIDENCE_SHA256"
)
COMPOSITE_CPU_EVIDENCE_SIZE: int | str = (
    "BLOCKED_PENDING_FRESH_V3_COMPOSITE_CPU_EVIDENCE_SIZE"
)
COMPOSITE_CPU_EVIDENCE_DIGEST = (
    "BLOCKED_PENDING_FRESH_V3_COMPOSITE_CPU_EVIDENCE_DIGEST"
)
...
def validate_composite_cpu_admission(
    ...
    if (
        ...
        != "PASS_COMPOSITE_CPU_EXACT26_ACTIVATION_IMPORT_V3_HOLD"
    ...
    if (
        ...
        != "PASS_FRESH_CANARY_V3_COMPOSITE_CPU_CONTROLLER_V3"
...
def require_fresh_outputs() -> None:
    ...
    # Exact-empty evidence/log namespaces also prove every revoked GPU-v4
...
def build_srun_argv(max_gate_step: int) -> list[str]:
    ...
    return [
        ...
        "--job-name=case01-object-trajectory-exact5-r64-gpu-v5",
