...
readonly runner="${launcher_root}/auh_run_full644_exploratory_r64_job141620_v3.sh"
readonly runner_sha256=ef5d460aff23089d70f8697eb3537d49f9a6bf29ec36f8619427a34f63ab0aa5
...
readonly capacity_output="${output_parent}/prelaunch-capacity-sft-r64-step1-v3"
readonly full644_output="${output_parent}/full644-r64-reference-dpo-preservation-one-pass-v3"
...
require_outer_envelope() {
  ...
  self_path="$0"
  [[ "${self_path}" == "${launcher_root}/auh_launch_full644_exploratory_r64_job141620_v3.sh" \
