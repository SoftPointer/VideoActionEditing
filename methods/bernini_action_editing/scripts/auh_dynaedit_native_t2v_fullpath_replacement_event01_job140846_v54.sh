...
case "$host" in
  auh7-1b-gpu-246)
    label=NATIVE_FULLPATH_DELTAVEL_REPLACE_ALL40_FORCEDC0_NOPRES
    transport=native_t2v_delta_velocity_replacement
    ;;
  auh7-1b-gpu-247)
    label=NATIVE_FULLPATH_TARGETVEL_REPLACE_ALL40_FORCEDC0_NOPRES
    transport=native_t2v_target_velocity_replacement
    ;;
  *)
    echo "Round 54 is restricted to Job 140846 nodes 246-247" >&2
    exit 3
    ;;
esac
...
export OUTPUT_ROOT_OVERRIDE="$stage/dynaedit_native_t2v_fullpath_replacement_event01_v54"
