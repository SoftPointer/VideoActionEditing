...
log="${root}/logs/eval_exact28_partial_seed20260821_seed20260822_v3.log"
[[ ! -e "${log}" && ! -e "${eval_root}/PARTIAL_SEED20260821_SEED20260822_COMPLETE" ]]
...
export FULL644_EVAL_VARIANTS=seed20260821,seed20260822
export FULL644_EVAL_SLOT_COUNT=2
export FULL644_EVAL_NODE_OFFSET=1
exec "${release}/auh_eval_full644_exact28_v6.sh" >"${log}" 2>&1
