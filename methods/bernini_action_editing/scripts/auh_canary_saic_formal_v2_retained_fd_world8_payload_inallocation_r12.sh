...
step_launch = module._decode_sealed(
    step_launch_raw,
    schema_version="saic-formal-v2-retained-fd-world8-inallocation-r12-step-launch-v1",
...
core = {
    "schema_version": "saic-formal-v2-retained-fd-world8-inallocation-r12-operational-evidence-v1",
