...
readonly expected_payload_sha=4b30a3fd8cdce12f24b86e499274c64734c969d0c425e2232859449b5800d3df
...
readonly expected_receipt_schema=saic-formal-v2-retained-fd-world8-inallocation-r12-step-launch-v1
readonly stage1_nonce=00f7cc1d872b1c02c8e71d9038b1646ed4f619e410ea52cdeb0a6b01befcaa3c

fail() { echo "[saic-fv2-fd-world8-inallocation-r12] ERROR: $*" >&2; exit 2; }
...
readonly pass_sentinel="SAIC_FV2_FD_WORLD8_INALLOCATION_R12_PASS ${job_step_id}"
printf '%s\n' "${pass_sentinel}"
trap - EXIT TERM INT
exit 0
