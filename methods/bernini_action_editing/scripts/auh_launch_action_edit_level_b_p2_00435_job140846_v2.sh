...
readonly controller="${launch_root}/auh_launch_action_edit_level_b_p2_00435_job140846_v2.sh"
readonly step_payload="${launch_root}/auh_action_edit_level_b_p2_00435_step_v2.sh"
readonly step_payload_sha=e67e2a1c61619f77f60ccf31cfb99738c1c7a165c37de90dc1a2bc4424ca8ca3
readonly rank_exec="${launch_root}/auh_action_edit_level_b_p2_00435_rank_exec_v2.sh"
readonly rank_exec_sha=45ea93aac371e15cf0133fd8a531e00cc238cc58e7430f61c33d30daadff9296
...
readonly launch_authority_core_sha=405c7374c740d2b7f525e30fa73c765176080552711abe5ac20998789788f094
readonly release_manifest="${release_root}/RELEASE_MANIFEST.json"
readonly release_manifest_sha=7cdfc7213d7edd68b580bf736cb0645ff1a41d4f3d70c55890a312961ce68b06
readonly renderer_sha=b07ec9603e4820b4b9cb52fe7c8994591e3e5e30afb71b504086b0d259c06d68
readonly attempt_intent_sha=6b4f5b118af5a3c982fcdf78fbff9fbb35732a4dd6cab5c267d4e5b02ebff068
readonly output_mp4="${run_root}/00435ad621c44fac_p2_seed2026080821_v2.mp4"
readonly output_receipt="${output_mp4}.receipt.json"
readonly output_marker="${output_mp4}.COMMITTED.json"
readonly job_name=bernini0817-level-b-p2-00435-v2
...
write_status() {
  ...
  "${python_bin}" -I -B -c '
import json,sys
out={"schema_version":"bernini-action-edit-level-b-p2-controller-status-v2","authority":"PRE_D0_ENGINEERING_ONLY","tag":"fresh-world8-level-b-p2-00435-v2","parent_job_id":140846,"node":"auh7-1b-gpu-279","child_exit_code":int(sys.argv[1]),"parent_state_before":sys.argv[2],"parent_state_after":sys.argv[3],"intent_path":sys.argv[4],"run_log_path":sys.argv[5],"automatic_relaunch_authorized":False,"parent_control_authorized":False}
...
readonly expected_launch_entries=$'LAUNCH_AUTHORITY_CORE.json\naction_edit_level_b_p2_00435_bootstrap_0817_v2.py\nauh_action_edit_level_b_p2_00435_rank_exec_v2.sh\nauh_action_edit_level_b_p2_00435_step_v2.sh\nauh_launch_action_edit_level_b_p2_00435_job140846_v2.sh'
...
readonly expected_run_entries=$'00435ad621c44fac_p2_seed2026080821_v2.mp4\n00435ad621c44fac_p2_seed2026080821_v2.mp4.COMMITTED.json\n00435ad621c44fac_p2_seed2026080821_v2.mp4.receipt.json'
