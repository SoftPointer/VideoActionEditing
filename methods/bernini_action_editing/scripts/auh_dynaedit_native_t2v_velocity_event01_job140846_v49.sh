...
case "$(hostname -s)" in
  auh7-1b-gpu-246)
    label=NATIVE_TRAJ_VEL_A025_EARLY3_AFFINE_P8_R8
    strength=0.25
    steps=3
    ;;
  auh7-1b-gpu-247)
    label=NATIVE_TRAJ_VEL_A050_EARLY8_AFFINE_P8_R8
    strength=0.50
    steps=8
    ;;
  *) echo "Round 49 is restricted to Job 140846 nodes 246-247" >&2; exit 3 ;;
esac

stage=/vast/users/guangyi.chen/causal_group/peiyuan.zhu/work/VideoEditing/VideoEdit_experiments/action_flow_noise_stage0_job140846_v1/stage1
export LABEL_OVERRIDE="$label"
export OUTPUT_ROOT_OVERRIDE="$stage/dynaedit_native_t2v_velocity_event01_v49"
