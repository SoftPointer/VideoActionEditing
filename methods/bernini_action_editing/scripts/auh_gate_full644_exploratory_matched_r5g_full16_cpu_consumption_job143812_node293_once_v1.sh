...
# Frozen against the fresh materialized release and r5f production source pins.
readonly R5G_CONTROLLER_STATE=READY
[[ "$R5G_CONTROLLER_STATE" == READY ]] || { printf '%s\n' 'r5g full16 CPU consumption gate is HOLD pending fresh materialization' >&2; exit 88; }
...
CONFIGS = {
    "consumption": {
        "step_name": "f644-r5g-full16-consume-v1",
        "parent": ROOT + "/diagnostics",
        "result_parent": WORK_ROOT,
        "result": "r5d-cpu-consumption-probe.json",
        "stdout": "r5g_full16_cpu_consumption_probe.stdout.log",
        "stderr": "r5g_full16_cpu_consumption_probe.stderr.log",
        "evidence": "r5g_full16_cpu_consumption_probe.sacct-and-replay.json",
    },
}
...
ROOT_PYTHON_SHA256="11dde438e1a636073e79c81d4c2543708cc0a2922e7c42c38b1b588e17545f96"
ROOT_PYTHON_SIZE=5937800
PROBE="/vast/users/guangyi.chen/causal_group/peiyuan.zhu/work/VideoEditing/VideoEdit_experiments/bernini_full644_exploratory_matched_eval_auh_r5f_job143812_node293_full16_847b91a2_c91de7eb_d70eac5c_r1/diagnostics/full644_exploratory_matched_r5f_cpu_consumption_probe_v1.py"
PROBE_SHA256="fd64fafc9580c8f25c88d79ca603a0dbf192ea98f77403e82f14d4e17c6905f6"
PROBE_SIZE=56009
VACE_PYTHON="/vast/users/guangyi.chen/anaconda3/envs/vace/bin/python3.12"
VACE_PYTHON_SHA256="8d7e74da2724b634c4ed5c7c5a583f21786883bc76bab93b3e381417a7f7483a"
VACE_PYTHON_SIZE=31490256
METHODS_ROOT="/vast/users/guangyi.chen/causal_group/peiyuan.zhu/work/VideoEditing/VideoEdit_experiments/bernini_full644_exploratory_matched_eval_auh_r5f_job143812_node293_full16_847b91a2_c91de7eb_d70eac5c_r1/release/methods/bernini_action_editing"
SITE_ROOT="/vast/users/guangyi.chen/anaconda3/envs/vace/lib/python3.12/site-packages"
WORK="/vast/users/guangyi.chen/causal_group/peiyuan.zhu/work/VideoEditing/VideoEdit_experiments/bernini_full644_exploratory_matched_eval_auh_r5f_job143812_node293_full16_847b91a2_c91de7eb_d70eac5c_r1/diagnostics/cpu_consumption_probe_work_r1"
...
def validate_sacct_raw_fixture():
    fixture = (
        "143812.181|f644-r5g-full16-consume-v1|COMPLETED|0:0|1|4|"
        "cpu=4,gres/gpu:mi210=8,gres/gpu=8,mem=8192M,node=1|"
        "auh7-1b-gpu-293|85286912"
    )
    parsed = parse_sacct_row(fixture, "143812.181")
    ...
    for hostile in (fixture + "|", fixture + "|extra", fixture.rsplit("|", 1)[0]):
        try:
            parse_sacct_row(hostile, "143812.181")
        except RuntimeError:
            continue
...
for leaf in (config["stdout"], config["stderr"], config["evidence"], os.path.basename(WORK_ROOT)):
    fresh_at(parent_fd, leaf)

probe_fd, probe_before, probe_raw = open_pinned(PROBE, PROBE_SHA256, PROBE_SIZE, 2012, 2000, 0o444)
payload_raw = COMPUTE_PAYLOAD
...
srun_argv = [
    ...
    "--time=00:10:00", "--job-name=" + config["step_name"], "/bin/bash", "-p", "-c", remote_wrapper, "/bin/bash",
]
...
evidence = {
    ...
    "payload": {
        "path": "trusted-controller-embedded-compute-payload", "sha256": payload_sha256, "size": len(payload_raw),
...
pass_line = (
    "R5G_FULL16_CPU_CONSUMPTION_HELDFD_GATE_PASS step=" + full_step + " receipt_digest=" + receipt_digest
