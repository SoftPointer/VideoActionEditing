...
# One SP4 arm per half-node.  Job 140846 must already own the compute node.
...
case "$(hostname -s):$1" in
  auh7-1b-gpu-246:0) arm=AQK_IID1 ;;
  auh7-1b-gpu-246:1) arm=AQK_ANC1 ;;
  auh7-1b-gpu-247:0) arm=AQK_AVG5 ;;
  auh7-1b-gpu-247:1) arm=AQK_SGA5 ;;
...
output_root="$stage/anchor_sga_anc_event01_v1"
output="$output_root/$arm.mp4"
...
scratch="/tmp/anchor-sga-anc-event01-$arm-140846"
