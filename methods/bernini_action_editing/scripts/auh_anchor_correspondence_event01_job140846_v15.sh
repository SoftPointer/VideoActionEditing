...
# Cross-identity/action alignment canary.  Phase-0 value features establish a
# semantic nearest-neighbour map from each current token to anchor tokens; the
# mapped temporal attention-output residual is then transported under true
# low-temperature SGA + weighted ANC-chain collapse.
...
case "$(hostname -s):$1" in
  auh7-1b-gpu-246:0) label=SGA001C_CORRO_A050_EARLY3_B8_13; blocks=8-13 ;;
  auh7-1b-gpu-247:0) label=SGA001C_CORRO_A050_EARLY3_B14_21; blocks=14-21 ;;
...
output_root="$stage/anchor_correspondence_event01_v15"
...
scratch="/tmp/anchor-correspondence-$label-140846"
