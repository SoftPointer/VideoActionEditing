...
# Strength boundary for the full pure-T2V velocity trajectory under the fixed
# DynaEdit SGA+ANC implementation.  The residual is frame-relative and sparse;
# no absolute anchor appearance field is copied.
...
case "$(hostname -s):$1" in
  auh7-1b-gpu-246:1) label=SGA001C_TRVEL_A050_EARLY8; strength=0.50 ;;
  auh7-1b-gpu-247:1) label=SGA001C_TRVEL_A100_EARLY8; strength=1.00 ;;
...
output_root="$stage/anchor_velocity_strength_event01_v16"
...
scratch="/tmp/anchor-velocity-strength-$label-140846"
