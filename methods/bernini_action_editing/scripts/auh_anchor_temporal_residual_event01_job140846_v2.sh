...
# Preservation recovery after hard-QK erased Event 01 source identity/scene.
...
case "$(hostname -s):$1" in
  auh7-1b-gpu-246:0)
    label=TRQK_A010_MID8_21; transport=temporal_residual_qk; strength=0.10; blocks=8-21 ;;
  auh7-1b-gpu-246:1)
    label=TRQK_A025_MID8_21; transport=temporal_residual_qk; strength=0.25; blocks=8-21 ;;
  auh7-1b-gpu-247:0)
    label=TRK_A025_MID8_21; transport=temporal_residual_k; strength=0.25; blocks=8-21 ;;
  auh7-1b-gpu-247:1)
    label=TRQK_A010_LATE20_29; transport=temporal_residual_qk; strength=0.10; blocks=20-29 ;;
...
output_root="$stage/anchor_temporal_residual_event01_v2"
...
scratch="/tmp/anchor-temporal-residual-$label-140846"
