...
case "$host" in
  ...
  auh7-1b-gpu-247)
    ...
    ;;
  *)
    echo "Round 55 is restricted to Job 140846 nodes 246-247" >&2
    exit 3
    ;;
esac

stage=/vast/users/guangyi.chen/causal_group/peiyuan.zhu/work/VideoEditing/VideoEdit_experiments/action_flow_noise_stage0_job140846_v1/stage1
export OUTPUT_ROOT_OVERRIDE="$stage/dynaedit_native_t2v_delta_cutoff_event01_v55"
...
for cutoff in "${cutoffs[@]}"; do
  ...
  "$stage/anchor_qk_dev_v1/auh_dynaedit_dynamic_static_anchor_event01_job140846_v27.sh" 0
done
