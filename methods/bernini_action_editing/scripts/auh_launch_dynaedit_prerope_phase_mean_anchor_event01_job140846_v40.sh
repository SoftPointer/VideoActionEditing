...
payload="$stage/anchor_qk_dev_v1/auh_dynaedit_prerope_phase_mean_anchor_event01_job140846_v40.sh"
root="$stage/dynaedit_prerope_phase_mean_anchor_event01_v40"
test -x "$payload"
mkdir -p "$root"
