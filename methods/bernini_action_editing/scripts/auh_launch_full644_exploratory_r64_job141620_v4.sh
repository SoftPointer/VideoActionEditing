...
readonly runner="${launcher_root}/auh_run_full644_exploratory_r64_job141620_v4.sh"
readonly runner_sha256=4ef35172615e31ab65721233653d82d6c9fd279c0dbc44fc53c19ec16f450d6d
...
readonly source_archive="${launcher_root}/full644_exploratory_r64_source_v2.tar"
readonly source_archive_sha256=d4647b39b3f8485043192ac2e9ee3082cca6173eb91d15b7d754a73f1b8b401c
readonly source_archive_size=1041408
readonly release_parent="${experiment_root}/releases"
readonly release_root="${release_parent}/full644-exploratory-r64-source-d4647b39b3f8"
...
readonly capacity_output="${output_parent}/prelaunch-capacity-sft-r64-step1-v4"
readonly full644_output="${output_parent}/full644-r64-reference-dpo-preservation-one-pass-v4"
...
require_outer_envelope() {
  ...
  self_path="$0"
  [[ "${self_path}" == "${launcher_root}/auh_launch_full644_exploratory_r64_job141620_v4.sh" \
