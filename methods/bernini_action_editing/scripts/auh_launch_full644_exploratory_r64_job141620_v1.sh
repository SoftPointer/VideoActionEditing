...
readonly runner="${launcher_root}/auh_run_full644_exploratory_r64_job141620_v1.sh"
readonly runner_sha256=0040e1b6b8721b1c4e5845b0ad11801e62a3ea43f34a4882af5bde171b5b68e6
readonly runner_size=27931
...
readonly capacity_output="${output_parent}/prelaunch-capacity-sft-r64-step1-v1"
readonly full644_output="${output_parent}/full644-r64-reference-dpo-preservation-one-pass-v1"
...
require_outer_envelope() {
  ...
  self_path="$0"
  [[ "${self_path}" == "${launcher_root}/auh_launch_full644_exploratory_r64_job141620_v1.sh" \
