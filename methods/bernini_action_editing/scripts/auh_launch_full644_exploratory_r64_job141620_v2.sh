...
readonly experiment_root=/vast/users/guangyi.chen/causal_group/peiyuan.zhu/work/VideoEditing/VideoEdit_experiments/bernini_full644_exploratory_r64_job141620_v2
readonly launcher_root="${experiment_root}/launchers/full644-exploratory-r64-job141620-v2"
readonly runner="${launcher_root}/auh_run_full644_exploratory_r64_job141620_v2.sh"
readonly runner_sha256=3152956e66cddb206d15ae4708b2fbb123aa915dff95b372cbacc1344b9cd5b4
readonly runner_size=27971
...
readonly source_archive="${launcher_root}/full644_exploratory_r64_source_v1.tar"
readonly source_archive_sha256=95a8aadf627805bc3f08dd90b651274398af42b9328b8e2be622d4ce271d4a82
readonly source_archive_size=994304
readonly release_parent="${experiment_root}/releases"
readonly release_root="${release_parent}/full644-exploratory-r64-source-95a8aadf6278"
readonly attempt_root="${experiment_root}/attempts/prelaunch-capacity-then-full644-v2"
readonly output_parent="${experiment_root}/runs"
readonly capacity_output="${output_parent}/prelaunch-capacity-sft-r64-step1-v2"
readonly full644_output="${output_parent}/full644-r64-reference-dpo-preservation-one-pass-v2"
...
require_outer_envelope() {
  ...
  self_path="$0"
  [[ "${self_path}" == "${launcher_root}/auh_launch_full644_exploratory_r64_job141620_v2.sh" \
