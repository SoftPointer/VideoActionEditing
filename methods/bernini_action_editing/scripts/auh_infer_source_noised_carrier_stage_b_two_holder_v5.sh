...
readonly expected_runtime_sha=7e6cdba95c62d2ae9bbe81cfa123ac208c2ca890f134cfe6d0538cefea68db50
readonly expected_dependency_sha=62df125ac130697b03aaea167b17a02d7fcb9d766a72f0bef71037924114e59f
readonly expected_release_archive_sha=e3880934c3e6cfcb0dfe56aa34a03f3ffbb2cb192a262fdb8ae1734a02f183ca
readonly expected_release_manifest_sha=6849ed11ad214e4c49f72731e4beb88948f2abf26e79f0ff5cf8c4e2814e62a3
readonly expected_release_revision=051db819ab8cca158a69cce58369b13d1dbb7531
...
usage() {
  cat >&2 <<'EOF'
usage: auh_infer_source_noised_carrier_stage_b_two_holder_v5.sh run
...
assert m["schema_version"]=="bernini-source-noised-carrier-stage-b-inference-release-v3"
assert m["release_generation"]=="r3" and m["file_count"]==14 and m["content_closure_sha1"]==revision
