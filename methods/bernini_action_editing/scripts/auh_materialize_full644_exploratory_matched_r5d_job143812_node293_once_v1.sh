#!/bin/bash
# One-shot, materialization-only handoff for the fresh r5d case00 package.
#
...
readonly R5D_TARGET_ROOT=/vast/users/guangyi.chen/causal_group/peiyuan.zhu/work/VideoEditing/VideoEdit_experiments/bernini_full644_exploratory_matched_eval_auh_r5d_job143812_node293_case00_847b91a2_c91de7eb_85ccc17b_r1
readonly R5D_PYTHON=/vast/users/guangyi.chen/anaconda3/envs/vace/bin/python3.12
readonly R5D_MATERIALIZER="${R5D_SOURCE_ROOT}/methods/bernini_action_editing/tools/materialize_full644_exploratory_matched_r5d_case00_package_v1.py"
...
if python_path!="/vast/users/guangyi.chen/anaconda3/envs/vace/bin/python3.12" or materializer_path!=source_root+"/methods/bernini_action_editing/tools/materialize_full644_exploratory_matched_r5d_case00_package_v1.py":
    fail("bootstrap frozen entry paths differ")
if source_root!="/vast/users/guangyi.chen/causal_group/peiyuan.zhu/work/VideoEditing/VideoEdit" or target_root!="/vast/users/guangyi.chen/causal_group/peiyuan.zhu/work/VideoEditing/VideoEdit_experiments/bernini_full644_exploratory_matched_eval_auh_r5d_job143812_node293_case00_847b91a2_c91de7eb_85ccc17b_r1":
...
materializer_raw=stable_fd(materializer_fd,materializer_path,"896ded9bf9351cc5f5af1eb52b06aa4bf0d9e8d322ffeefef04a908cd92275af",0o644,False,36487)
try:
...
if ident(os.fstat(materializer_fd))!=ident(os.lstat(materializer_path)) or hashlib.sha256(read_fd(materializer_fd,os.fstat(materializer_fd).st_size)).hexdigest()!="896ded9bf9351cc5f5af1eb52b06aa4bf0d9e8d322ffeefef04a908cd92275af":
