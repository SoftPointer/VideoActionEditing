...
readonly release_root="${experiment_root}/releases/full644-exploratory-r64-source-12a28ddec997"
readonly trainer="${release_root}/methods/bernini_action_editing/train_lora.py"
readonly trainer_sha256=ead547b8309e1b5ae5c831444e9f5d1d8e1785fed5fe39cf7b97f13f82a9ce85
readonly trainer_size=157494
readonly method_source_revision=ce4cffc1e8a144448c92252d9fb63087f03bbd8c
readonly method_source_archive_sha256=12a28ddec99704963af42f1a82b09dff31828e3af8e53e5d0bbd0d43db272828
...
readonly capacity_output="${experiment_root}/runs/prelaunch-capacity-sft-r64-step1-v5"
readonly full644_output="${experiment_root}/runs/full644-r64-reference-dpo-preservation-one-pass-v5"
