...
# Pure-T2V action contrast belongs to the target conditional branch.  Under
# raw CFG it is therefore amplified by gamma_tar instead of being diluted as
# a common edit to the target conditional and negative branches.
...
case "$(hostname -s):$1" in
  auh7-1b-gpu-246:0)
    label=CAPTIONSTATIC_CFG45_85_CONDATT_A003_EARLY8
    strength=0.03
    transport_steps=8
    ;;
  auh7-1b-gpu-246:1)
    label=CAPTIONSTATIC_CFG45_85_CONDATT_A003_ALL40
    strength=0.03
    transport_steps=40
    ;;
  auh7-1b-gpu-247:0)
    label=CAPTIONSTATIC_CFG45_85_CONDATT_A006_EARLY8
    strength=0.06
    transport_steps=8
    ;;
  auh7-1b-gpu-247:1)
    label=CAPTIONSTATIC_CFG45_85_CONDATT_A006_ALL40
    strength=0.06
    transport_steps=40
    ;;
...
output_root="$stage/dynaedit_conditional_anchor_event01_v23"
...
scratch="/tmp/dynaedit-conditional-anchor-$label-140846"
