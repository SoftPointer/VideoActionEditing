...
readonly RELEASE="$BASE/release_canary_74fe161f_v2"
...
readonly CODE_SHA=74fe161f08eb92746ce22f00b50cca65f85ef05e4a4a6a5d0c7fb85867e94233
readonly TEST_SHA=e8f998e9e979ee18bda3cd7cde1462c0ca37cfa9c3d9108324096cca27167298
...
case "$1" in
  smoke)
    readonly STEPS=2
    readonly OUTPUT="$BASE/runs/canary_74fe161f_smoke_v2"
    ;;
  full)
    readonly STEPS=1200
    readonly OUTPUT="$BASE/runs/canary_74fe161f_exact644_v2"
    ;;
  *)
