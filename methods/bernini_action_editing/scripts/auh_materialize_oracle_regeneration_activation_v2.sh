#!/usr/bin/env bash
# WORLD4 authoring launcher for one activation-v2 VAE or prompt receipt.
#
...
vae_tool="${method_root}/tools/materialize_oracle_regeneration_vae_refs_activation_v2.py"
prompt_tool="${method_root}/tools/materialize_oracle_regeneration_prompts_activation_v2.py"
static_test="${method_root}/tests/test_oracle_regeneration_activation_v2_materializers.py"
...
declare -A expected_sha256=(
  ...
  ["${static_test}"]="d7f3816f3fa9c7d4ce9ee0a3cddffc3fdbc0f1ff78c2288408ebb55a030eb644"
