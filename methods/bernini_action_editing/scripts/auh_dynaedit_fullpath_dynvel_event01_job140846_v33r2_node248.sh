...
# Round-32 dynamic-minus-static velocity arm except transport_steps=40;
...
case "$(hostname -s)" in
  auh7-1b-gpu-248)
    label=FULLPATH_DYNVEL_A010_B8_13
    ...
    ;;
  *)
    echo "this payload is restricted to Job 140846 node 248" >&2
    exit 3
    ;;
esac
...
output_root="$stage/dynaedit_fullpath_dynvel_event01_v33r3_4686c2f1_3f3390e2_3e7f8e44"
...
scratch="/tmp/dynaedit-fullpath-dynvel-v33r3-$label-140846-node248"
