...
readonly expected_payload_sha=a7a161e03c807a7ba006adb102caf3a2b209dfa20d030fd96a57d823d9568fb8
...
readonly expected_receipt_schema=saic-formal-v2-retained-fd-world8-inallocation-r14-step-launch-v1
readonly stage1_nonce=675c339730aa0716454d644e034dd5d4950a9bd302f48eeaeae2234fb7d1612d

fail() { echo "[saic-fv2-fd-world8-inallocation-r14] ERROR: $*" >&2; exit 2; }
...
readonly pass_sentinel="SAIC_FV2_FD_WORLD8_INALLOCATION_R14_PASS ${job_step_id}"
printf '%s\n' "${pass_sentinel}"
trap - EXIT TERM INT
exit 0
