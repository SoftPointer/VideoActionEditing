...
step_launch = module._decode_sealed(
    step_launch_raw,
    schema_version="saic-formal-v2-retained-fd-world8-inallocation-r13-step-launch-v1",
...
core = {
    "schema_version": "saic-formal-v2-retained-fd-world8-inallocation-r13-operational-evidence-v1",
