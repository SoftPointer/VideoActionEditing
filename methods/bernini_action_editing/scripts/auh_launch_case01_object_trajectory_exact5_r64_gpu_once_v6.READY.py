#!/usr/bin/env python3
"""Fresh-v6 receipt-gated one-shot GPU controller for exact-five.
...
SCHEMA = "case01-object-trajectory-exact5-r64-gpu-controller-v6"
...
ATTEMPT_PATH = PACKAGE_ROOT / "evidence/exact5_gpu_attempt_v6.json"
DISPATCH_PATH = PACKAGE_ROOT / "evidence/exact5_gpu_dispatch_v6.json"
EVIDENCE_PATH = PACKAGE_ROOT / "evidence/exact5_gpu_controller_receipt_v6.json"
STDOUT_PATH = PACKAGE_ROOT / "logs/exact5_gpu_srun_v6.stdout.log"
STDERR_PATH = PACKAGE_ROOT / "logs/exact5_gpu_srun_v6.stderr.log"
...
def require_fresh_outputs() -> None:
    ...
    # Exact-empty evidence/log namespaces also prove every revoked GPU-v4/v5
...
def build_srun_argv(max_gate_step: int) -> list[str]:
    ...
    return [
        ...
        "--job-name=case01-object-trajectory-exact5-r64-gpu-v6",
