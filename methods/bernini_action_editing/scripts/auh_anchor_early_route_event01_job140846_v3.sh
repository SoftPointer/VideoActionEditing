...
# Isolate online anchor transport from late-step artifacting.  Every arm uses
# exact first-latent-phase clamping after each clean edit-state update.
...
case "$(hostname -s):$1" in
  auh7-1b-gpu-246:0)
    label=FLOWEDIT_ANC1_NO_ANCHOR; transport=temporal_residual_qk; strength=0.10; steps=0; blocks=8-21 ;;
  auh7-1b-gpu-246:1)
    label=TRQK_A010_EARLY3_MID8_21; transport=temporal_residual_qk; strength=0.10; steps=3; blocks=8-21 ;;
  auh7-1b-gpu-247:0)
    label=TRQK_A010_EARLY8_MID8_21; transport=temporal_residual_qk; strength=0.10; steps=8; blocks=8-21 ;;
  auh7-1b-gpu-247:1)
    label=TRK_A025_EARLY3_MID8_21; transport=temporal_residual_k; strength=0.25; steps=3; blocks=8-21 ;;
  *) echo "this canary is restricted to Job 140846 nodes 246-247" >&2; exit 3 ;;
esac
...
output_root="$stage/anchor_early_route_event01_v3"
...
scratch="/tmp/anchor-early-route-$label-140846"
