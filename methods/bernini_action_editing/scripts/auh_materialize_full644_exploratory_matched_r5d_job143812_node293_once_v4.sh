#!/bin/bash
# One-shot handoff for the fresh r3 package from its sealed 21-file snapshot.
#
...
readonly R5D_SOURCE_ROOT=/vast/users/guangyi.chen/causal_group/peiyuan.zhu/work/VideoEditing/VideoEdit_experiments/bernini_full644_exploratory_matched_r5d_source_snapshot_21_20260820_r2
readonly R5D_TARGET_ROOT=/vast/users/guangyi.chen/causal_group/peiyuan.zhu/work/VideoEditing/VideoEdit_experiments/bernini_full644_exploratory_matched_eval_auh_r5d_job143812_node293_case00_847b91a2_c91de7eb_85ccc17b_r3
readonly R5D_PYTHON=/vast/users/guangyi.chen/anaconda3/envs/vace/bin/python3.12
readonly R5D_MATERIALIZER="${R5D_SOURCE_ROOT}/methods/bernini_action_editing/tools/materialize_full644_exploratory_matched_r5d_case00_package_v3.py"
...
if python_path!="/vast/users/guangyi.chen/anaconda3/envs/vace/bin/python3.12" or materializer_path!=source_root+"/methods/bernini_action_editing/tools/materialize_full644_exploratory_matched_r5d_case00_package_v3.py":
    fail("bootstrap frozen entry paths differ")
if source_root!="/vast/users/guangyi.chen/causal_group/peiyuan.zhu/work/VideoEditing/VideoEdit_experiments/bernini_full644_exploratory_matched_r5d_source_snapshot_21_20260820_r2" or target_root!="/vast/users/guangyi.chen/causal_group/peiyuan.zhu/work/VideoEditing/VideoEdit_experiments/bernini_full644_exploratory_matched_eval_auh_r5d_job143812_node293_case00_847b91a2_c91de7eb_85ccc17b_r3":
...
source_specs=(
    ...
    ("methods/bernini_action_editing/full644_exploratory_matched_r5d_static_nomodel_probe_v2.py","fd6829d3b1f4b0e3bcbed91889b4f6f76eaf45a5884d44a9b9110ac87eb6cb4f"),
...
materializer_raw=stable_fd(materializer_fd,materializer_path,"a3429bccc50dde540d705ec2add7ca9c34d4dfb8a34e25fe631af3593a9ea794",0o644,False,36169)
try:
...
if ident(os.fstat(materializer_fd))!=ident(os.lstat(materializer_path)) or hashlib.sha256(read_fd(materializer_fd,os.fstat(materializer_fd).st_size)).hexdigest()!="a3429bccc50dde540d705ec2add7ca9c34d4dfb8a34e25fe631af3593a9ea794":
