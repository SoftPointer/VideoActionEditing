...
log="${root}/logs/eval_exact28_partial_frozen_seed20260820_v6.log"
[[ ! -e "${log}" && ! -e "${eval_root}/PARTIAL_FROZEN_SEED20260820_COMPLETE" ]]
...
export FULL644_EVAL_VARIANTS=frozen,seed20260820
export FULL644_EVAL_SLOT_COUNT=1
