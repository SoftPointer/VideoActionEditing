...
# Remove APG from both source/target FlowEdit fields.  This is a diagnostic of
# the outer edit trajectory, not a final recommendation about guidance.
...
case "$(hostname -s):$1" in
  auh7-1b-gpu-246:1)
    label=RAW_FLOWEDIT_ANC1_NO_ANCHOR_NO_CLAMP; steps=0 ;;
  auh7-1b-gpu-247:1)
    label=RAW_TRQK_A010_EARLY3_NO_CLAMP; steps=3 ;;
...
output_root="$stage/anchor_raw_field_event01_v6"
...
scratch="/tmp/anchor-raw-field-$label-140846"
