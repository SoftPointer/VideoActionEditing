...
# Local, read-only staging and decode QA for the one fresh node293 r5c case00
# canary.  This script never starts a Slurm step and never writes remotely.

REMOTE_HOST="auh"
REMOTE_ROOT="/vast/users/guangyi.chen/causal_group/peiyuan.zhu/work/VideoEditing/VideoEdit_experiments/bernini_full644_exploratory_matched_eval_auh_r5c_job143812_case00_847b91a2_c91de7eb_cb201398_r3"
SOURCE_PATH="/vast/users/guangyi.chen/dataset/goku/subject_movement/extracted/videos/1852ada01d7c43a4/source.mp4"
PLAN_SHA256="24db212f40e807e51be1fa5127c5c21f6b5adb12219921b9087f0e10a52d8174"
PLAN_DIGEST="52945a64e50b3db729936d2ddfe0809da7d5a5cea2b8297ffd1652eeba1357be"
...
[[ "$(sha256sum "$plan" | cut -d' ' -f1)" == "24db212f40e807e51be1fa5127c5c21f6b5adb12219921b9087f0e10a52d8174" ]]
...
jq -e '
  ...
  .holder_job_id == "143812" and
  .node == "auh7-1b-gpu-293" and
...
stage="$(mktemp -d /tmp/full644-node293-case00-visual-qa.XXXXXX)"
...
if (
    ...
    or evidence.get("node") != "auh7-1b-gpu-293"
...
manifest = {
    "schema_version": "full644-node293-case00-local-visual-qa-stage-v1",
