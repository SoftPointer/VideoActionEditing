...
SCHEMA = "case01-object-trajectory-exact5-r5f-v4-composite-cpu-controller-v3"
...
CONTROLLER_STATE = "HOLD_PENDING_FRESH_CANARY_V3_CPU_V3_AUDIT"
...
ATTEMPT_PATH = EXPERIMENTS / (
    "bernini_case01_object_trajectory_exact5_r64_canary_v3."
    "composite_cpu_admission_attempt_v3.json"
)
...
STDOUT_PATH = EXPERIMENTS / (
    "bernini_case01_object_trajectory_exact5_r64_canary_v3."
    "composite_cpu_admission_srun_v3.stdout.log"
)
STDERR_PATH = EXPERIMENTS / (
    "bernini_case01_object_trajectory_exact5_r64_canary_v3."
    "composite_cpu_admission_srun_v3.stderr.log"
)
...
try:
 ...
 cache_root="/tmp/bernini-case01-object-trajectory-r5f-v4-composite-cpu-v3-job%s-step%s-cache"%(job_id,step_id)
...
def build_srun_argv() -> list[str]:
    return [
        ...
        "--job-name=case01-object-r5f-v4-composite-cpu-v3",
...
def controller() -> dict[str, Any]:
    ...
    try:
        ...
        release = {
            "schema_version": (
                "case01-object-trajectory-exact5-r5f-v4-composite-cpu-release-v3"
            ),
