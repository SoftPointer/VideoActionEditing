...
# Diagnose whether byte-exact first-phase projection, rather than the anchor,
# pushes the clean edit state outside Bernini's valid temporal manifold.
...
case "$(hostname -s):$1" in
  auh7-1b-gpu-246:0)
    label=FLOWEDIT_ANC1_NO_ANCHOR_NO_CLAMP; strength=0.10; steps=0 ;;
  auh7-1b-gpu-247:0)
    label=TRQK_CFG2_A010_EARLY3_NO_CLAMP; strength=0.10; steps=3 ;;
...
output_root="$stage/anchor_no_clamp_event01_v5"
...
scratch="/tmp/anchor-no-clamp-$label-140846"
