#!/bin/bash
# One-shot handoff for the fresh r5f package from its sealed 21-file snapshot.
#
...
readonly R5D_SOURCE_ROOT=/vast/users/guangyi.chen/causal_group/peiyuan.zhu/work/VideoEditing/VideoEdit_experiments/bernini_full644_exploratory_matched_r5f_source_snapshot_21_20260820_r1
readonly R5D_TARGET_ROOT=/vast/users/guangyi.chen/causal_group/peiyuan.zhu/work/VideoEditing/VideoEdit_experiments/bernini_full644_exploratory_matched_eval_auh_r5f_job143812_node293_case00_847b91a2_c91de7eb_d70eac5c_r1
readonly R5D_PYTHON=/vast/users/guangyi.chen/anaconda3/envs/vace/bin/python3.12
readonly R5D_MATERIALIZER="${R5D_SOURCE_ROOT}/methods/bernini_action_editing/tools/materialize_full644_exploratory_matched_r5f_case00_package_v1.py"
...
if python_path!="/vast/users/guangyi.chen/anaconda3/envs/vace/bin/python3.12" or materializer_path!=source_root+"/methods/bernini_action_editing/tools/materialize_full644_exploratory_matched_r5f_case00_package_v1.py":
    fail("bootstrap frozen entry paths differ")
if source_root!="/vast/users/guangyi.chen/causal_group/peiyuan.zhu/work/VideoEditing/VideoEdit_experiments/bernini_full644_exploratory_matched_r5f_source_snapshot_21_20260820_r1" or target_root!="/vast/users/guangyi.chen/causal_group/peiyuan.zhu/work/VideoEditing/VideoEdit_experiments/bernini_full644_exploratory_matched_eval_auh_r5f_job143812_node293_case00_847b91a2_c91de7eb_d70eac5c_r1":
...
source_specs=(
    ...
    ("methods/bernini_action_editing/full644_exploratory_matched_r5f_static_nomodel_probe_v1.py","242a48d6720ef4514f841c518a5a9dbdd864102e60d0aa12d845496b6a02b5cd"),
...
materializer_raw=stable_fd(materializer_fd,materializer_path,"4c6e8c9db7b92750be0e580d0e655b9009b300963983b33750d6697c72bdd0b1",0o644,False,36398)
try:
...
if ident(os.fstat(materializer_fd))!=ident(os.lstat(materializer_path)) or hashlib.sha256(read_fd(materializer_fd,os.fstat(materializer_fd).st_size)).hexdigest()!="4c6e8c9db7b92750be0e580d0e655b9009b300963983b33750d6697c72bdd0b1":
