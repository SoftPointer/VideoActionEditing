...
readonly expected_payload_sha=8d7e4fc18f2e6ee7eb977972267dc03156c8ba8c35f5e14d1509c95bdb04a5fa
...
readonly expected_receipt_schema=saic-formal-v2-retained-fd-world8-inallocation-step-launch-v1
readonly stage1_nonce=88caeec5033c5b5a0e2b3885d600d56e5f7e5168c14bdff4db1070188560ea5c

fail() { echo "[saic-fv2-fd-world8-inallocation-r11] ERROR: $*" >&2; exit 2; }
...
if (value.get("status")!="compute_step_bootstrap_admitted"
        ...
        or hashlib.sha256(module.canonical(value["exact_srun_argv"])).hexdigest()
...
readonly pass_sentinel="SAIC_FV2_FD_WORLD8_INALLOCATION_R11_PASS ${job_step_id}"
printf '%s\n' "${pass_sentinel}"
trap - EXIT TERM INT
exit 0
