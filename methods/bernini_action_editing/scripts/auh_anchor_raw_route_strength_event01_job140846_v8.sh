...
# On the stable raw RV2V FlowEdit field, test whether the prior weak residual
# simply under-conditioned action transport.
...
case "$(hostname -s):$1" in
  auh7-1b-gpu-246:1)
    label=RAW_TRQK_A050_EARLY8; transport=temporal_residual_qk; strength=0.50; steps=8 ;;
  auh7-1b-gpu-247:1)
    label=RAW_HARDK_EARLY3; transport=hard_k; strength=1.00; steps=3 ;;
...
output_root="$stage/anchor_raw_route_strength_event01_v8"
...
scratch="/tmp/anchor-raw-strength-$label-140846"
