...
case "$(hostname -s)" in
  ...
  *) echo "training is restricted to Job 140846 nodes 246/247" >&2; exit 3 ;;
esac
...
manifest="$release/pairs_exact/manifest_${mode}.json"
output="$release/train_joint_${mode}_q12x20_all30_r256_micro1_s64_v3"
...
scratch="/tmp/complex8-joint-${mode}-140846"
