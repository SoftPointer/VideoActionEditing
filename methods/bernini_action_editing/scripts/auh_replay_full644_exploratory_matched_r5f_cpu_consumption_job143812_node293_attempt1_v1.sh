...
# controller attempt before its postflight field-name bug.  Reuse only that
# tombstone; this replay-only validator never submits or executes an srun.
...
evidence = {
    "schema_version": "full644-r5f-consumption-replay-only-controller-evidence-v1", "status": "PASS",
