#!/bin/bash
# One-shot handoff for the fresh r2 package from its sealed 21-file snapshot.
#
...
readonly R5D_SOURCE_ROOT=/vast/users/guangyi.chen/causal_group/peiyuan.zhu/work/VideoEditing/VideoEdit_experiments/bernini_full644_exploratory_matched_r5d_source_snapshot_21_20260820_r1
readonly R5D_TARGET_ROOT=/vast/users/guangyi.chen/causal_group/peiyuan.zhu/work/VideoEditing/VideoEdit_experiments/bernini_full644_exploratory_matched_eval_auh_r5d_job143812_node293_case00_847b91a2_c91de7eb_85ccc17b_r2
readonly R5D_PYTHON=/vast/users/guangyi.chen/anaconda3/envs/vace/bin/python3.12
readonly R5D_MATERIALIZER="${R5D_SOURCE_ROOT}/methods/bernini_action_editing/tools/materialize_full644_exploratory_matched_r5d_case00_package_v2.py"
...
if python_path!="/vast/users/guangyi.chen/anaconda3/envs/vace/bin/python3.12" or materializer_path!=source_root+"/methods/bernini_action_editing/tools/materialize_full644_exploratory_matched_r5d_case00_package_v2.py":
    fail("bootstrap frozen entry paths differ")
if source_root!="/vast/users/guangyi.chen/causal_group/peiyuan.zhu/work/VideoEditing/VideoEdit_experiments/bernini_full644_exploratory_matched_r5d_source_snapshot_21_20260820_r1" or target_root!="/vast/users/guangyi.chen/causal_group/peiyuan.zhu/work/VideoEditing/VideoEdit_experiments/bernini_full644_exploratory_matched_eval_auh_r5d_job143812_node293_case00_847b91a2_c91de7eb_85ccc17b_r2":
...
source_specs=(
    ...
    ("methods/bernini_action_editing/full644_exploratory_matched_r5d_static_nomodel_probe_v1.py","4b17a1919a6ef928d572f769d6713a4764b0d31dc6da77eb7498cc5152c6de6c"),
...
materializer_raw=stable_fd(materializer_fd,materializer_path,"79a3fc988bbdcd74abf13823a7046ffba9c984f660e57b0c0678b4412cfa96e6",0o644,False,36169)
try:
...
if ident(os.fstat(materializer_fd))!=ident(os.lstat(materializer_path)) or hashlib.sha256(read_fd(materializer_fd,os.fstat(materializer_fd).st_size)).hexdigest()!="79a3fc988bbdcd74abf13823a7046ffba9c984f660e57b0c0678b4412cfa96e6":
