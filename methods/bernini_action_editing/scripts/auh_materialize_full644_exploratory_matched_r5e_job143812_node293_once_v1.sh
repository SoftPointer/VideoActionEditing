#!/bin/bash
# One-shot handoff for the fresh r5e package from its sealed 21-file snapshot.
#
...
readonly R5D_SOURCE_ROOT=/vast/users/guangyi.chen/causal_group/peiyuan.zhu/work/VideoEditing/VideoEdit_experiments/bernini_full644_exploratory_matched_r5e_source_snapshot_21_20260820_r1
readonly R5D_TARGET_ROOT=/vast/users/guangyi.chen/causal_group/peiyuan.zhu/work/VideoEditing/VideoEdit_experiments/bernini_full644_exploratory_matched_eval_auh_r5e_job143812_node293_case00_847b91a2_c91de7eb_85ccc17b_r1
readonly R5D_PYTHON=/vast/users/guangyi.chen/anaconda3/envs/vace/bin/python3.12
readonly R5D_MATERIALIZER="${R5D_SOURCE_ROOT}/methods/bernini_action_editing/tools/materialize_full644_exploratory_matched_r5d_case00_package_v5.py"
...
if python_path!="/vast/users/guangyi.chen/anaconda3/envs/vace/bin/python3.12" or materializer_path!=source_root+"/methods/bernini_action_editing/tools/materialize_full644_exploratory_matched_r5d_case00_package_v5.py":
    fail("bootstrap frozen entry paths differ")
if source_root!="/vast/users/guangyi.chen/causal_group/peiyuan.zhu/work/VideoEditing/VideoEdit_experiments/bernini_full644_exploratory_matched_r5e_source_snapshot_21_20260820_r1" or target_root!="/vast/users/guangyi.chen/causal_group/peiyuan.zhu/work/VideoEditing/VideoEdit_experiments/bernini_full644_exploratory_matched_eval_auh_r5e_job143812_node293_case00_847b91a2_c91de7eb_85ccc17b_r1":
...
source_specs=(
    ...
    ("methods/bernini_action_editing/full644_exploratory_matched_r5d_static_nomodel_probe_v4.py","887a810560e4f2ece560e4e1a766c88845cf623547ab9230879cd2a6839e693b"),
...
materializer_raw=stable_fd(materializer_fd,materializer_path,"994e463c55cd73d151707da762f04a6150a15631bc4bff90dfe71359b61ff82a",0o644,False,36398)
try:
...
if ident(os.fstat(materializer_fd))!=ident(os.lstat(materializer_path)) or hashlib.sha256(read_fd(materializer_fd,os.fstat(materializer_fd).st_size)).hexdigest()!="994e463c55cd73d151707da762f04a6150a15631bc4bff90dfe71359b61ff82a":
