...
readonly experiment_root=/vast/users/guangyi.chen/causal_group/peiyuan.zhu/work/VideoEditing/VideoEdit_experiments/bernini_full644_exploratory_r64_job141620_v3
readonly launcher_root="${experiment_root}/launchers/full644-exploratory-r64-job141620-v3"
...
readonly capacity_output="${experiment_root}/runs/prelaunch-capacity-sft-r64-step1-v3"
readonly full644_output="${experiment_root}/runs/full644-r64-reference-dpo-preservation-one-pass-v3"
readonly attempt_root="${experiment_root}/attempts/prelaunch-capacity-then-full644-v3"
