...
# LOCAL VERIFICATION TEMPLATE ONLY.  The r8 release explicitly sets
...
readonly BOOTSTRAP="${REPO_ROOT}/methods/bernini_action_editing/tools/v15c_r8_external_bootstrap.py"
readonly RELEASE="${REPO_ROOT}/methods/bernini_action_editing/assets/e00_source_sam2_proposal_role_probe_v15c_r8_release.json"
readonly PYTHON_AUTHORITY="/vast/users/guangyi.chen/anaconda3/envs/vace/bin/python3.12"
readonly BOOTSTRAP_SHA256="db71c9f55cb5d53a5b1606b3ea17c35a2651019670cef53280bcb0e1ab4aaacc"
readonly RELEASE_SHA256="d77d5d7cae221d1fc3cbf82c8b1f6f72483b477870cfc5c2b7f88738d1c9ee1c"
readonly PYTHON_SHA256="8d7e74da2724b634c4ed5c7c5a583f21786883bc76bab93b3e381417a7f7483a"

fail() {
  echo "v15c-r8 local verifier: $*" >&2
  exit 1
}
...
exec /usr/bin/env -i \
  HOME=/nonexistent/v15c-r8-local-verifier \
  LANG=C \
  LC_ALL=C \
...
' v15c-r8-python "${PYTHON_AUTHORITY}" \
