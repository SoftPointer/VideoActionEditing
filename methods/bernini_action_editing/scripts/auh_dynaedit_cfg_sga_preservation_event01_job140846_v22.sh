...
# Preservation search after high raw CFG first produced the requested Event-01
# action.  One pair interpolates the published CFG settings; the other keeps
# the successful high CFG and sharpens DynaEdit's SGA source-similarity choice.
...
case "$(hostname -s):$1" in
  auh7-1b-gpu-246:0)
    label=CAPTIONSTATIC_CFG35_65_SGA001C_NOANCHOR
    source_cfg=3.5
    target_cfg=6.5
    ...
    ;;
  auh7-1b-gpu-246:1)
    label=CAPTIONSTATIC_CFG35_65_SGA001C_ATTCON_A025_ALL40
    source_cfg=3.5
    target_cfg=6.5
    sga_temperature=0.01
    transport_steps=40
    ;;
  auh7-1b-gpu-247:0)
    label=CAPTIONSTATIC_CFG45_85_SGA0001C_NOANCHOR
    source_cfg=4.5
    target_cfg=8.5
    sga_temperature=0.001
    transport_steps=0
    ;;
  auh7-1b-gpu-247:1)
    label=CAPTIONSTATIC_CFG45_85_SGA0001C_ATTCON_A025_ALL40
    source_cfg=4.5
    target_cfg=8.5
    sga_temperature=0.001
    transport_steps=40
...
output_root="$stage/dynaedit_cfg_sga_preservation_event01_v22"
...
scratch="/tmp/dynaedit-cfg-sga-preservation-$label-140846"
