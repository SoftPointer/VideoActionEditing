...
readonly RUN_BASE="/vast/users/guangyi.chen/causal_group/peiyuan.zhu/work/VideoEditing/VideoEdit_experiments/action_flow_noise_stage0_job143808_v15c_r5"
readonly BOOTSTRAP="${REPO_ROOT}/methods/bernini_action_editing/tools/v15c_r5_external_bootstrap.py"
readonly RELEASE="${REPO_ROOT}/methods/bernini_action_editing/assets/e00_source_sam2_proposal_role_probe_v15c_r5_release.json"
readonly PYTHON_BIN="/vast/users/guangyi.chen/anaconda3/envs/vace/bin/python3.12"
readonly BOOTSTRAP_SHA256="0304aae83e2d5c6e1bdea7c4be820829a808a36d9dcdcee6276fba69395a4bbc"
readonly RELEASE_SHA256="f944b732ac99da089ee94708adc75674dfdbdea3ba9aa7f37c48eda866ba6cc2"
readonly PYTHON_SHA256="8d7e74da2724b634c4ed5c7c5a583f21786883bc76bab93b3e381417a7f7483a"

fail() {
  echo "v15c-r5 external launch template: $*" >&2
  exit 1
}
...
clean_env=(
  /usr/bin/env -i
  HOME=/nonexistent/v15c-r5-bootstrap
  LANG=C
  LC_ALL=C
...
" v15c-r5-python "${python_bin}" /proc/self/fd/8 /proc/self/fd/9 \
