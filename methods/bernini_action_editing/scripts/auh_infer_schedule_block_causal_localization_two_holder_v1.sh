...
usage() {
  cat >&2 <<'EOF'
usage: auh_infer_schedule_block_causal_localization_two_holder_v1.sh run
...
assert value["schema_version"]=="bernini-schedule-block-causal-localization-release-v1"
assert value["release_generation"]=="r1" and value["content_closure_sha1"]==revision
