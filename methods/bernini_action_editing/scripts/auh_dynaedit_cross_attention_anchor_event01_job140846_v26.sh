...
# Move the online pure-T2V action-minus-noop route from visual self-attention
# to text cross-attention.  This targets the seam where the action caption is
# represented, while keeping source rows and target phase zero unchanged.
...
scratch="/tmp/dynaedit-cross-attn-$label-140846"
