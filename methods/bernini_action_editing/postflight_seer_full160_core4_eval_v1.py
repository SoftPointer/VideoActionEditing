...
SCHEMA_VERSION = "bernini-seer-full160-core4-eval-master-binding-v1"
...
def aggregate(
    *,
    ...
    for iid in CORE4_IIDS:
        ...
        elif current_overlay != overlay_identity or current_adapter != adapter_identity:
            raise PostflightError("core4 overlay/adapter identity differs across cases")
        case_rows.append(
            {
                "iid": iid,
                "path": str(path),
