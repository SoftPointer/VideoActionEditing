#!/usr/bin/env python3
"""Create-only HOLD launcher materializer for the fresh r5f-v3 exact-five.
...
METHOD_ROLE_BASENAMES = {
    "runner": "case01_object_trajectory_exact5_runner_v3.py",
    "legacy_exact5_runner": "case01_source_bone_exact5_runner_v1.py",
    "object_eval": "case01_object_trajectory_exact5_eval_v3.py",
    ...
    "adapter": "infer_case01_object_trajectory_oracle_auh_r5f_v3.py",
